...
public class CampaignAgmtPackageDTO implements Serializable {
    ...
    public boolean equals(Object obj) {
        if (this == obj)
            return true;
        if (!(obj instanceof CampaignAgmtPackageDTO))
            return false;
        CampaignAgmtPackageDTO that = (CampaignAgmtPackageDTO) obj;
