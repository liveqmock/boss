  ...
  public boolean equals(Object obj) {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass())) {
        GuestLedgerDTO that = (GuestLedgerDTO) obj;
        return ( ( (this.getReason() == null) && (that.getReason() == null)) ||
                (this.getReason() != null &&
            ...
            this.getCustId() == that.getCustId() && this.getAcctId
            () == that.getAcctId() &&
            ...
            this.getReferAmount() == that.getReferAmount() &&
            this.getReferSheetID() == that.getReferSheetID() &&
            this.getConfirmAmount() == that.getConfirmAmount();
      }
    }
    return false;
  }
  ...
  public String toString()
          {
                  ...
                  buf.append(",").append(referAmount);
                  buf.append(",").append(confirmAmount);
