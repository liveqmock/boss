...
<Script language=JavaScript>
	...
	function frm_submit()
	{
	   ...
	   document.frmPost.action="batch_query_modify.do";
...
<%
String title = "批量查询操作修改----信息确认";
if(CommonConstDefinition.YESNOFLAG_YES.equals(request.getParameter("txtTemplateFlag")))
	title = "批量查询模板操作修改----信息确认";
%>   
<form name="frmPost" method="post" action="batch_query_modify.do">
<tbl:hiddenparameters pass="txtTemplateFlag" />
 ...
 <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" background="img/line_01.gif">
  <tr>
    <td><img src="img/mao.gif" width="1" height="1"></td>
      ...
      <!--头记录参数区-->
      <tbl:hiddenparameters pass="txtQueryType/txtQueryName/txtQueryDesc/txtScheduleType/txtScheduleTime" />
      <!--客户信息参数区-->
      ...
      <tbl:hiddenparameters pass="txtAccountInvoiceStatusList/txtAccountAddress" />
      ...
      <tbl:hiddenparameters pass="txtDtLastmod/txtQueryID/txtStatus/txtCreateTime" />
      
      <input type="hidden" name="txtActionType" value="modify" >
      <input type="hidden" name="func_flag"  value="8002" >
      <tbl:generatetoken />
</form>