...
function query_module_submit(){
     document.frmPost.templateFlag.value = "<%=CommonConstDefinition.YESNOFLAG_YES%>";
      document.frmPost.action="batch_query_module_query.do";
      document.frmPost.submit();
}

function view_batch_detail(batchid){
	var strURL="batch_query_show_detail.do?txtQueryID="+batchid+"&txtActionType=batch";
...
function batch_query_module_create_submit(){
	document.frmPost.templateFlag.value = "<%=CommonConstDefinition.YESNOFLAG_YES%>";
	document.frmPost.action="batch_query_create.screen";
	document.frmPost.submit();
}

function batch_query_basemodule_create_submit(queryid){
	var templateFlag = "<%=CommonConstDefinition.YESNOFLAG_YES%>";
	document.frmPost.action="batch_module_query_create.do?txtQueryID="+queryid+"&templateFlag="+templateFlag;
	document.frmPost.submit();
}
...
<form name="frmPost" method="post" action="batch_query_module_query.do">
	...
	<tr align="center">
	  <td class="list_bg1"><table  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<td><input name="Submit" type="button" class="button" value="查&nbsp;询" onclick="javascript:query_module_submit()"></td>
...
<tbl:printcsstr style1="list_bg1" style2="list_bg2" overStyle="list_over" >
    <td align="center" class="t12"><tbl:write name="QueryDTO" property="queryId"/></td>
    ...
    {%>
    	<a href="javascript:batch_query_basemodule_create_submit('<tbl:write name="QueryDTO" property="queryId"/>')" class="link12" >创建批量查询</a>
    <%}%>	
    </td>
</tbl:printcsstr>
</lgc:bloop>
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="1">
	<tr align="center">
	  	<td ><table  border="0" cellspacing="0" cellpadding="0">
		  	<tr>
				<td width="11" height="20"><img src="img/button_l.gif" width="11" height="20"></td>
				<td><input name="Submit" type="button" class="button" value="批量查询创建" onclick="javascript:batch_query_create_submit()"></td>
				<td width="22" height="20"><img src="img/button_r.gif" width="22" height="20"></td>
				<td width="20" ></td>
		    	<td width="11" height="20"><img src="img/button_l.gif" width="11" height="20"></td>
		    	<td><input name="Submit" type="button" class="button" value="批量查询模板创建" onclick="javascript:batch_query_module_create_submit()"></td>
		    	<td width="22" height="20"><img src="img/button_r.gif" width="22" height="20"></td>
		  	</tr>
	  	</table></td>
	</tr>
