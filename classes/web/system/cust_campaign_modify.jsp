...
<form name="frmPost" method="post" action="cust_campaign_modify_op.do" >
	<input type="hidden" name="txtActionType" value="campaignModify">
	<input type="hidden" name="txtAutoExtendFlag" value="">
   ...
   <%
      ...
      String accountName = Postern.getAcctNameById(dto.getAccountID());
    ...
    %> 
      <table align="center" width="100%" border="0" cellspacing="1" cellpadding="3" class="list_bg" >
         ...
         <tr>
          ...
          <input type="text" name="txtAccoutName" size="25" maxlength="10" value="<%=accountName%>" class="textgray" readonly >
        ...
        <tr>
          ...
          <td class="list_bg1"  align="left"><d:selcmn name="txtAllowAlter" mapName="SET_G_YESNOFLAG" match="allowAlter" width="23" /></td>        
        </tr>
        <tr>
          <td class="list_bg2" align="right">是否允许暂停</td>
          <td class="list_bg1"  align="left"><d:selcmn name="txtAllowPause" mapName="SET_G_YESNOFLAG" match="allowPause" width="23" /></td>
          <td class="list_bg2" align="right">是否允许迁移</td>
          <td class="list_bg1"  align="left"><d:selcmn name="txtAllowTransition" mapName="SET_G_YESNOFLAG" match="allowTransition" width="23" /></td> 
        </tr>
        <tr>
          <td class="list_bg2" align="right">是否允许过户</td>
          <td class="list_bg1"  align="left"><d:selcmn name="txtAllowTransfer" mapName="SET_G_YESNOFLAG" match="allowTransfer" width="23" /></td>
          <td class="list_bg2" align="right">是否允许取消</td>
          <td class="list_bg1"  align="left"><d:selcmn name="txtAllowClose" mapName="SET_G_YESNOFLAG" match="allowClose" width="23" /></td> 
        </tr>
		    <tr>
		  	 <td class="list_bg2" ><div align="right">备注</div></td>
		  	 <td class="list_bg1" colspan="3" >
		     <input type="text" name="txtComments" size="80" value="<tbl:write name="oneline" property="comments" />" >
		     </td>
		    </tr>
      </table>
