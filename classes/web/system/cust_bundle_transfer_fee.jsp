...
<!--
	...
	function back_submit(){
		if(document.frmPost.TerminalDeviceList!=null&&document.frmPost.TerminalDeviceList.value!=null){
  ...
  <table width="100%" align="center" border="0" cellspacing="1" cellpadding="5" class="list_bg">
     <tr>
      ...
      <table align="center" width="100%" border="0" cellspacing="1" cellpadding="3" class="list_bg" > 
   	 ...
   	 <tbl:CommonFeeAndPaymentInfo includeParameter="Fee" payCsiType="<%=CommonKeys.CUSTSERVICEINTERACTIONTYPE_BDS%>" acctshowFlag ="true"  />		 
