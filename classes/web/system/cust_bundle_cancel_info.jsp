  ...
  <table width="100%" align="center" border="0" cellspacing="1" cellpadding="5" class="list_bg">
     <tr>
      ...
      <table align="center" width="100%" border="0" cellspacing="1" cellpadding="3" class="list_bg" > 
        ...
        <tr>
           <tbl:csiReason csiType="BDC" name="txtCsiCreateReason" match="txtCsiCreateReason" action="N" showType="text" checkScricptName="check_csiReason()" controlSize="25" tdWordStyle="list_bg2" tdControlStyle="list_bg1" tdControlColspan="3" forceDisplayTD="true"/>
        </tr>
      </table>   
