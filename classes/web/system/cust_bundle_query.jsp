...
function cust_bundle_detail_click(ccID){
	self.location.href="cust_bundle_detail.do?txtActionType=bundle&txtCCID="+ ccID ;
}
...
<%
	int customerID=WebUtil.StringToInt(request.getParameter("txtCustomerID"));
 	pageContext.setAttribute("CAMPAIGNMAP",Postern.getCampaignMapByTypeORCustID(CommonKeys.CAMPAIGNCAMPAIGNTYPE_OPEN,customerID));
...
<form name="frmPost" action="cust_bundle_query.do" method="post" >    
   <table width="100%" align="center" border="0" cellspacing="1" cellpadding="3" class="list_bg">
     ...
     <tr>  
      <td class="list_bg2" width="17%"><div align="right">套餐</div></td>
    ...
    <tr>   
      <td class="list_bg2"><div align="right">套餐开始日期起</div></td>
      <td class="list_bg1"  align="left" >
		...
		<td class="list_bg2"><div align="right">套餐开始日期止</div></td>
      <td class="list_bg1"  align="left" >
    ...
    <tr>   
      <td class="list_bg2"><div align="right">套餐结束日期起</div></td>
      <td class="list_bg1"  align="left" >
      ...
      <td class="list_bg2"><div align="right">套餐结束日期止</div></td>
      <td class="list_bg1"  align="left" >
...
<rs:hasresultset>
   ...
   <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg" >     
      <tr class="list_head"> 
          <td width="10%" class="list_head"><div align="center">客户套餐号</div></td>
          <td width="30%" class="list_head"><div align="center">套餐名称</div></td>                    
          <td width="15%" class="list_head"><div align="center">设备号</div></td> 
          <td width="10%" class="list_head"><div align="center">业务账户ID</div></td>         
          <td width="7%" class="list_head"><div align="center">状态</div></td>
          <td width="14%" class="list_head"><div align="center">协议期（开始）</div></td>
          <td width="14%" class="list_head"><div align="center">协议期（结束）</div></td>
      </tr> 
...
<%
    ...
    if (scSerialNo.equals("")){
       scSerialNo =Postern.getSTBSerialNoByServiceAccountID(dto.getServiceAccountID());
    }
%>
    <tbl:printcsstr style1="list_bg1" style2="list_bg2" overStyle="list_over" >
      	 <td align="center" ><a href="javascript:cust_bundle_detail_click('<tbl:write name="oneline" property="ccID"/>');"><tbl:write name="oneline" property="ccID"/></a></td>
      	 <td align="center" ><%=ccName%></td>      		
      	 <td align="center" ><%=scSerialNo%></td>
...
<rs:notlast>
 ...
 <input type="hidden" name="txtActionType" value="bundle">   
