...
<table width="100%" align="center" border="0" cellspacing="1"
	...
	<tr>
		...
		<td class="list_bg1"><font size="2"><tbl:select name="txtHostID" set="hosts" 
			width="23" match="txtHostID"/></font></td>
	</tr>
	<tr>
		...
		<td class="list_bg1" colspan="3"><input name="txtCondString"
			...
			value="<tbl:writeparam name="txtCondString" />"></td>
	</tr>
	<tr>
	...
	<tr align="center">
	  ...
	  <table align="center"  border="0" cellspacing="0" cellpadding="0">
         <tr>  
            ...
            <td><input name="Submit" type="button" class="button"
					value="保&nbsp;存" onclick="javascript:ca_condition_create()"></td>
