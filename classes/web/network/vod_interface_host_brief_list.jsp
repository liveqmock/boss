...
function view_detail(hostID){	
	self.location.href="vod_interface_host_editing.do?txtHostID="+hostID+"&editing_type=update";
} 
...
function new_editing(){
	self.location.href="vod_interface_host_editing.do?editing_type=new";
}
 ...
 <br>
			...
			<form name="frmPost" method="post" action="vod_interface_host_query.do" >
			<rs:hasresultset>
 			<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
         			...
         			<tr class="list_head">
           				...
           				<td class="list_head">VOD系统类型 </td>
           				<td class="list_head">接口协议类型 </td>
            			        <td class="list_head">状态 </td>
        			</tr>
				<lgc:bloop requestObjectName="ResponseQueryResult" item="oneline" >					
	 			<tr class="list_bg1" onmouseover="this.className='list_over'" onmouseout="this.className='list_bg1'">
	     			<td align="center"><a href="javascript:view_detail('<tbl:write name="oneline" property="hostID"/>')" class="link12" ><tbl:write name="oneline" property="hostID" /></a></td>
      	     			<td align="center"><tbl:write name="oneline" property="hostName"/></td>
      	     			<td align="center"><tbl:write name="oneline" property="vodType"/></td>
