...
<rs:hasresultset>
	<table width="100%" border="0" align="center" cellpadding="5"
		...
		<tr class="list_head">
			<td class="list_head" width="10%" align="center">流水号</td>
			<td class="list_head" width="20%" align="center">语音条件名称</td>
			<td class="list_head" width="35%" align="center">语音条件内容</td>
			<td class="list_head" width="35%" align="center">描述</td>
		</tr>
