...
<td align="center" valign="top"><table  border="0" align="center" cellpadding="0" cellspacing="10">
      ...
      <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0" background="img/line_01.gif">
        <tr>
         ...
         <br>
<form name="frmPost" method="post" action="catv_cancel_jobcard.do" > 
...
<%
    Collection colFeeList = Postern.getAllFeeListByCsiAndType(WebUtil.StringToInt(request.getParameter("txtJobCardID")), "J");
    double fTotalFee = 0;
...
<%
    Collection colPaymentList = Postern.getAllPaymentListByCsiAndType(WebUtil.StringToInt(request.getParameter("txtJobCardID")),"J");
    String paymentName ="";
 ...
 <table align="center" border="0" cellspacing="0" cellpadding="0">
        <tr> 
           <td><img src="img/button2_r.gif" width="22" height="20"></td>
            <td background="img/button_bg.gif"><a href="<bk:backurl property="catv_job_card_view_for_contact.do" />" class="btn12">上一步</a></td>           
