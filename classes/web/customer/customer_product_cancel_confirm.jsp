...
<form name="frmPost" method="post" action="customer_product_cancel_op.do" >     
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
  <tr>
   ...
   <tr>
    ...
    <td class="list_bg1" ><input name="txtAcctName" type="text" class="textgray" readonly maxlength="10" size="22" value="<tbl:writeparam name="txtAcctName" />"></td>
...
<tbl:CommonFeeAndPaymentInfo includeParameter="Fee_Pay" payCsiType="<%=CommonKeys.CUSTSERVICEINTERACTIONTYPE_CP%>" acctshowFlag ="true"  confirmFlag="true" />	
<tbl:generatetoken />
...
<tr> 
  <td width="11" height="20"><img src="img/button2_r.gif" width="22" height="20"></td>
   ...
   <td height="20">
	 <input name="next" type="button" class="button" onClick="javascript:frm_submit()" value="确  定">
   </td>
