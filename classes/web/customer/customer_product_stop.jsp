...
<form name="frmPost" method="post" action="customer_product_stop_confirm.screen" > 
	...
	<input type="hidden" name="func_flag" value="7001"> 
	<input type="hidden" name="txtEventReasonName" value="">
	

     <table  border="0" align="center" cellpadding="0" cellspacing="5">
        <tr>
          <td><img src="img/list_tit.gif" width="19" height="19"></td>
          <td class="title">产品暂停</td>
        </tr>
      </table>
      <br>
...
<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
  <tr>
   ...
   <tr>
    ...
    <td class="list_bg1"><d:selcmn name="txtEventReason"
								mapName="SET_V_CUSTSERVICEINTERACTIONSTATUSREASON"
								match="txtEventReason" empty="false" width="20" />
							</td-->
	<tbl:csiReason csiType="PS" name="txtEventReason" action="N" showType="text"  checkScricptName="check_csiReason()" tdWordStyle="list_bg2" tdControlStyle="list_bg1" forceDisplayTD="true" match="txtEventReason"  controlSize="25" />
  </tr>
</table>
<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0" background="img/line_01.gif">
        <tr>
...
<script language=javascript>
	...
	function frm_finish(){
		...
		if(document.frmPost.txtEventReason != null)
		{
			var selectEventReason = document.frmPost.txtEventReason;
			document.frmPost.txtEventReasonName.value = selectEventReason.options[selectEventReason.selectedIndex].text;
		}
			document.frmPost.action="customer_product_stop_create.do";
