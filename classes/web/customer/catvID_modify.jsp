...
<!--
function frm_submit(){
	//if (check_Blank(document.frmPost.txtCatvID, true, "模拟用户代码"))
	//{	
  //	return false;
  //}	
  if(document.frmPost.txtCatvID.value==document.frmPost.txtOldCatvID.value){
  	alert("修改前后的模拟用户代码一样,请重新选择");
  	return ;
  }
...
<%
String catvName = request.getParameter("catvName");
%>

<form name="frmPost" method="post" action="catvID_modify.do" >
    <input type="hidden" name="Action" value="update">
    <input type="hidden" name="txtOldCatvID" value="<tbl:writeparam name="txtCatvID"/>" />
    ...
    <table width="100%"  border="0" align="center" cellpadding="4" cellspacing="1" class="list_bg">
       <tr>
	        <td valign="middle" class="list_bg2" align="right" width="34%"><%=catvName%>*</td>
	        <td class="list_bg1" width="66%">
	          <input type="text" name="txtCatvID" maxlength="<%=catvIdLength%>" size="25" value="<tbl:writeparam name="txtCatvID" />" class="text">
	        </td>
       </tr>
