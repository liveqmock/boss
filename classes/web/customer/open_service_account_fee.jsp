...
%>   
     ...
     <tbl:CommonFeeAndPaymentInfo includeParameter="Fee" payCsiType="<%=CommonKeys.CUSTSERVICEINTERACTIONTYPE_UO%>" acctshowFlag ="true" packageList="<%=allProductList%>" />  
...
function back_submit(){
  ...
  if (product_attr =="0"){
	    ...
	    document.frmPost.action="open_service_account_product.do";
	}else {
	 	document.frmPost.txtActionType.value ="";
	    document.frmPost.action="menu_open_service_account.screen";
	 }
	 ...
	 if (check_ProductProperty()){
	    ...
	    if (check_fee()){
	       document.frmPost.action="open_service_account_pay.screen";
	 	     ...
	 	     //document.frmPost.action="open_service_account_confirm.do";
	 	     //document.frmPost.confirm_post.value="true";
	 	     document.frmPost.action="open_service_account_fee_confirm.screen";
