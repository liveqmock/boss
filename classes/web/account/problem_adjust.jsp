...
<SCRIPT language="JAVASCRIPT">
	function next_submit(){
		...
		var strUrl='';
		if (adjustType==f){
			strUrl='problem_adjust_fee.screen';
		}else if (adjustType==c){
			strUrl='problem_adjust_payment.screen';
		}
		if(strUrl!=''){
...
<table width="820" align="center" cellpadding="0" cellspacing="0">
	<tr> 
      ...
      <tr>
        ...
        <td class="title">报修单调帐--选择调帐类型</td>
      </tr>
		</table>
      ...
      <tr>
		...
		<tbl:hiddenparameters pass="txtCustId" />
		...
		<table align="center" width="100%" border="0" cellspacing="1" cellpadding="5" class="fulltable" >      
	   	<tr>
				...
				<td class="list_bg1" width='33%'>
					<input type='text' name='txtStatusShow' size='25' maxlength=='25' value='<tbl:writeparam name="txtStatusShow" />' class="textgray" readonly>
				</td>
			</tr>			
	   	<tr>
				<td class="list_bg2" align="right" width='17%'>
				...
				<td class="list_bg1" width='33%'>
					<input type="text" name="txtSurname" size="25" maxlength="25" value="<tbl:writeparam name="txtSurname" />" class="textgray" readonly>
				</td>
			</tr>
	   	<tr>
				<td class="list_bg2" align="right" width='17%'>
    	...
    	<tr>      
    		<bk:canback url="cp_query_detail.do" >
          <td><img src="img/button2_r.gif" border="0" ></td>
          <td background="img/button_bg.gif"><a href="<bk:backurl property="cp_query_detail.do" />" class="btn12">返&nbsp;回</a></td>
