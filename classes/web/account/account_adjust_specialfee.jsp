...
<SCRIPT language="JAVASCRIPT">
	function next_submit(){
		if(check_from()){
			document.frmPost.action='account_adjust_specialfee_confirm.screen';
...
<table width="820" align="center" cellpadding="0" cellspacing="0">
	<tr> 
      ...
      <tr>
        ...
        <td class="list_bg1" align="left">
          <input type="text" name="txtFeeDate1" size="25" value="<tbl:writeparam name="txtAdjustDate"/>" >&nbsp;<IMG onclick="calendar(document.frmPost.txtFeeDate1)" src="img/calendar.gif" style=cursor:hand border="0">
        </td>
        <td class="list_bg2" align="right">
        	费用日期2
        </td>
        <td class="list_bg1" align="left">
          <input type="text" name="txtFeeDate2" size="25" value="<tbl:writeparam name="txtAdjustDate"/>" >&nbsp;<IMG onclick="calendar(document.frmPost.txtFeeDate2)" src="img/calendar.gif" style=cursor:hand border="0">
        </td>
			</tr>
      <tr>
        <td class="list_bg2" align="right">
