...
String hiddenValues=request.getParameter("txtHiddenValues");
			...
			String strBackUrl = "account_adjust.do";
			String strButtonValue = "返回帐户调帐";
			String strActionUrl = "account_adjust.do";


			if (sFlag != null) {
				if (sFlag.equalsIgnoreCase(CommonKeys.ADJUST_REFERCODETYPE_D)) {
					strErrBackUrl = "account_adjust_prepaymentdeduction.screen";
					strErrButtonValue = "返回预存抵扣调帐";
				} else if (sFlag.equalsIgnoreCase(CommonKeys.ADJUST_REFERCODETYPE_F)) {
					strErrBackUrl = "account_adjust_fee.screen";
					strErrButtonValue = "返回应收费用调帐";
				} else if (sFlag.equalsIgnoreCase(CommonKeys.ADJUST_REFERCODETYPE_P)) {
					strErrBackUrl = "account_adjust_prepayment.screen";
					strErrButtonValue = "返回实收预存调帐";
				} else if (sFlag.equalsIgnoreCase(CommonKeys.ADJUST_REFERCODETYPE_C)) {
					strErrBackUrl = "account_adjust_payment.screen";
					strErrButtonValue = "返回实收支付调帐";
				} else {
					strBackUrl = "account_adjust.do";
					strButtonValue = "返回帐户调帐";
				}
			}
