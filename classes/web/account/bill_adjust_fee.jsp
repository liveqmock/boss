...
<table width="820" align="center" cellpadding="0" cellspacing="0">
	<tr> 
      ...
      <tr>
		...
		<form name="frmPost" method="post" action="bill_adjust_op.do">
      ...
      <tr>
        ...
        <td class="list_bg1" align="left">
          <input maxlength="10" onfocus="viewModule(this)" onKeydown="inputDate(document.frmPost.txtFeeDate1)" onblur="lostFocus(this)" type="text" name="txtFeeDate1" size="25" value="<tbl:writeparam name="txtAdjustDate"/>" >&nbsp;<IMG onclick="MyCalendar.SetDate(this,document.frmPost.txtFeeDate1,'Y')" src="img/calendar.gif" style=cursor:hand border="0">
        </td>
        <td class="list_bg2" align="right">
        	费用日期2
        </td>
        <td class="list_bg1" align="left">
          <input maxlength="10" onfocus="viewModule(this)" onKeydown="inputDate(document.frmPost.txtFeeDate2)" onblur="lostFocus(this)" type="text" name="txtFeeDate2" size="25" value="<tbl:writeparam name="txtAdjustDate"/>" >&nbsp;<IMG onclick="MyCalendar.SetDate(this,document.frmPost.txtFeeDate2,'Y')" src="img/calendar.gif" style=cursor:hand border="0">
        </td>
			</tr>			
      <tr>
        <td class="list_bg2" align="right">
