...
function check_frm()
{
    ...
    if (check_Blank(document.frmPost.txtFiberTransmitterCode, true, "编号"))
	    return false;
...
function create_submit(){
  if (check_frm()){
	    document.frmPost.action="create_fiber_transmitter.do";
...
<table width="810" align="center" border="0" cellspacing="1" cellpadding="3">
	<input type="hidden" name="func_flag" value="1040" > 
	<input type="hidden" name="Action" value="" > 
	<tr>
          <td class="list_bg2"><div align="right">编号*</div></td>
          <td class="list_bg1"> 
            <input type="text" name="txtFiberTransmitterCode" maxlength="20" size="25" value="<tbl:writeparam name="txtFiberTransmitterCode" />" >
           </td>      
