...
<TABLE border="0" align="center" cellspacing="0" cellpadding="0"
	...
	<TR>
		...
		<lgc:haserror>
			...
			<script language="JavaScript" type="text/JavaScript">
				parent.leftFrame.location.href="treeAction.do?key=district_<tbl:writeparam name="txtQryBelongTo"/>";
				parent.leftFrame.location.href="treeAction.do?key=district_<tbl:writeparam name="txtQryBelongTo"/>";
			</script>
		...
		<form name="frmPost" method="post" action="">
			<tbl:hiddenparameters pass="txtQryBelongTo/txtDistrictCode/txtDistrictName/txtDistrictType/txtStatus" />
		<table width="50%" border="0" align="center" cellpadding="0"
			cellspacing="10">
			<tr align="center">
				<td height="37">
				...
				case 101:
					...
					%>
							...
							<td><input name="Submit22" type="button" class="button"
								onClick="javascript:frmSubmit('<bk:backurl property='district_setting_create.screen' />')"
								value="返回"></td>
				...
				case 102:
					...
					%>
							<td width="11" height="20"><img src="img/button_l.gif" width="11"
								height="20"></td>
							<td><input name="Submit22" type="button" class="button"
								onClick="javascript:frmSubmit('<bk:backurl property='district_setting_query_detail.do' />')"
								value="返回"></td>
							<td width="22" height="20"><img src="img/button_r.gif" width="22"
								height="20"></td>
			...
			%>
						...
						<td width="11" height="20"><img src="img/button_l.gif" width="11"
							height="20"></td>
						<td><input name="Submit22" type="button" class="button"
							onClick="javascript:frmSubmit('<bk:backurl property='district_setting_query_result.do' />')"
							value="返回"></td>
						<td width="22" height="20"><img src="img/button_r.gif" width="22"
							height="20"></td>
							<!-- 见鬼了,出来不 -->
