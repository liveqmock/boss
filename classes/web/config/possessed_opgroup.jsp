...
<%
    ...
    if (checkFlags == null)
        checkFlags = "";
    List priList = Postern.getCurrentHaveOpGroup(WebUtil.StringToInt(request.getParameter("txtOperatorID")));
%>
...
%>
	 ...
	 <td align="center"><input type="checkbox" name="Flags" <%=check%> value="<%=i%>"></div></td>
         ...
         <td align="center"><input type="text" name="txtPrivName" size="17" value="<%=dto.getOpGroupName()%>" class="textgray" readonly/></td>
         <td align="center"><input type="text" name="txtPrivDesc" size="18" value="<%=des%>" class="textgray" readonly/></td>
