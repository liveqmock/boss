            ...
            <table align="center" border="0" cellspacing="0" cellpadding="0">
			   <tr>
			    <td><img src="img/button2_r.gif" width="20" height="20"></td>
	                <td background="img/button_bg.gif"><a href="<bk:backurl property="operator_query.do/config_operator_detail.do"/>" class="btn12">返  回</a></td>
...
function delete_opgroup() {
    if (checkForm()) {
        ...
        document.frmPost.action="delete_opgroup.do";
...
function add_opgroup() {
    if (checkAddForm()) {
        ...
        document.frmPost.action="add_opgroup.do";
        document.frmPost.submit();
    }
}
//-->
