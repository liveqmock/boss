...
function update_submit(id){
	document.frmPost.action = "district_setting_query_detail.do?txtDetailID="+id;
	document.frmPost.submit();
}
function add_submit(id){
	document.frmPost.action = "district_setting_create.screen";
	document.frmPost.submit();
}
...
<table  border="0" align="center" cellpadding="0" cellspacing="10" >
  <tr>
    ...
    <td class="title">直属下级行政区</td>
  </tr>
</table>
<form name="frmPost" action="district_setting_query_result.do" method="post" >    
...
<!-- 		<td><div align="center">
		<input type="checkbox" name="txtIndex" value="<tbl:write name="oneline" property="Id"/>">
		</div></td> -->
		<td class="t12" align="center" ><a href="javascript:update_submit('<tbl:write name="oneline" property="Id"/>')"><tbl:write name="oneline" property="Name"/></a></td>
		<td class="t12" align="center" ><tbl:write name="oneline" property="DistrictCode"/></td>
		<td class="t12" align="center" ><d:getcmnname typeName="SET_G_DISTRICTTYPE" match="oneline:type" /></td>
		<td class="t12" align="center" ><d:getcmnname typeName="SET_G_GENERALSTATUS" match="oneline:status" /></td>
	</tbl:printcsstr>
</lgc:bloop>
