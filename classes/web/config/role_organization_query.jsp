      ...
      <td class="list_bg2" colspan="4" align="center">
          <table  border="0" cellspacing="0" cellpadding="0">
			  <tr>
				...
				<td width="11" height="20"><img src="img/button_l.gif" width="11" height="20"></td>
				<td><input name="Submit" type="button" class="button" value="新 增" onclick="javascript:create_submit()"></td>
				<td width="22" height="20"><img src="img/button_r.gif" width="22" height="20"></td>
			  </tr>
	      </table>
     </tr>
...
<rs:hasresultset>
   ...
   <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg" >     
      <tr class="list_head"> 
          <td width="10%" class="list_head"><div align="center">流水号</div></td>
          <td width="20%" class="list_head"><div align="center">客户所属区域</div></td>                    
          <td width="17%" class="list_head"><div align="center">单据类型</div></td> 
          <td width="17%" class="list_head"><div align="center">创建业务帐户的产品</div></td>         
          <td width="20%" class="list_head"><div align="center">提供服务的组织</div></td>
          <td width="15%" class="list_head"><div align="center">是否优先处理</div></td>
      </tr> 
