...
{
	self.location.href="config_detail.do?txtID="+strId;
}
...
function detail_delete(id) {
    ...
    document.frmPost.action="config_delete_detail.do?Action=deleteDetail";
    document.frmPost.submit();
} 
function create_config_submit() {
    
   document.frmPost.action="config_create.screen";
   document.frmPost.submit();
}
</script>
...
<form name="frmPost" method="post" action="config_query_result.do" >
...
<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0" background="img/line_01.gif">
  ...
  <table align="center" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td background="img/button_bg.gif"><a href="javascript:create_config_submit()" class="btn12">创&nbsp;建</a></td>
