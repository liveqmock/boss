...
function create_submit(){
  if (check_frm()){
	    document.frmPost.action="create_machine_room.do";
...
<table width="810" align="center" border="0" cellspacing="1" cellpadding="3">
	<input type="hidden" name="func_flag" value="1043" > 
	...
	<tr>
          ...
          <td class="list_bg1"> 
           ...
           <td class="list_bg1">
           <input type="text" name="txtMachineRoomName" maxlength="10" size="25" value="<tbl:writeparam name="txtMachineRoomName" />" >
         </td>
        </tr>
      <tr>
	    ...
	    <input name="selDistButton" type="button" class="button" value="选择" onClick="javascript:sel_district('all','txtDistrictID','txtCountyDesc')">
         ...
         <tr>
          ...
          <input type="text" name="txtDescription" maxlength="100" size="84"   value="<tbl:writeparam name="txtDescription" />" >
          </td>    
