...
{
	self.location.href="fiber_node_detail_config.do?txtID="+strId;
}
function create_submit()
{
	self.location.href="fiber_node_create.screen";
}
...
<br>
<form name="frmPost" method="post" action="fibernode_query.do" >
   <table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
     <tr>
          <td class="list_bg2"><div align="right">编号</div></td>
          <td class="list_bg1"> 
            <input type="text" name="txtFiberNodeCode" maxlength="20" size="25" value="<tbl:writeparam name="txtFiberNodeCode" />" >
           </td>      
          <td class="list_bg2" align="right" width="17%">光接收机编号</td>
		<td class="list_bg1" width="33%">
		<tbl:select name="txtFiberRecieverId" set="CODE" match="txtFiberRecieverId" width="23"/></td>
           </tr>
       <tr>
...
<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
         <tr class="list_head">
          <td class="list_head">内部ID</td>
          <td class="list_head">编号</td>
          <td class="list_head">光接收机ID</td>
