...
function query_submit(){
	document.frmPost.action="forcedeposit_futureright_stat.do";
	if(checkDate()){  
...
<form name="frmPost" method="post" action="forcedeposit_futureright_stat.do">
	...
	<tr align="center">
	  <td class="list_bg1"><table  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<pri:authorized name="forcedeposit_futureright_stat_excel.do" >
