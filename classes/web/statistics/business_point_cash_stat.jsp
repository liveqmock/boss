...
function query_submit(){
	document.frmPost.action="business_point_cash_stat.do";
	if(checkData())
...
<form name="frmPost" method="post" action="business_point_cash_stat.do">
...
<table width="822"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
  ...
  <tr>
  	<%
  	//所有 not 'I' 的支付方式 
    pageContext.setAttribute("MOPSet", Postern.getAllValidMOPAndOnlyIdAndNameByPaymentFlag("Y"));
		%>     
	...
	<tr align="center">
	  <td class="list_bg1"><table  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<pri:authorized name="business_point_cash_stat_excel.do" >
			<td width="22" height="20">
			<td width="11" height="20"><img src="img/button_l.gif" width="11" height="20"></td>
			<td><input name="Submit" type="button" class="button" value="保存结果" onclick="javascript:save_query_result('营业员收费统计',true)"></td>
			<td width="22" height="20"><img src="img/button_r.gif" width="22" height="20"></td>
			</pri:authorized>
		  </tr>
	  </table></td>
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg" id="inTable">
  <tr class="list_head">
    <td class="list_head" rowspan="2" nowrap>收费人</td>
