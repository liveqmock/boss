...
function query_submit(){
	document.frmPost.action="campaign_catch_stat.do";
	if(checkDate()){ 
...
function checkDate(){
	if (document.frmPost.txtCreateTime1.value != ''){
		if (!check_TenDate(document.frmPost.txtCreateTime1, true, "捕获时间开始日期")){
			return false;
		}
	}
	if (document.frmPost.txtCreateTime2.value != ''){
		if (!check_TenDate(document.frmPost.txtCreateTime2, true, "捕获时间结束日期")){
			return false;
		}
	}


	if(!compareDate(document.frmPost.txtCreateTime1,document.frmPost.txtCreateTime2,"捕获时间结束日期必须大于等于捕获时间开始日期")){
		
		return false;
	}
	
	if (document.frmPost.txtCreateTime3.value != ''){
		if (!check_TenDate(document.frmPost.txtCreateTime3, true, "持续期间开始日期")){
			return false;
		}
	}
	if (document.frmPost.txtCreateTime4.value != ''){
		if (!check_TenDate(document.frmPost.txtCreateTime4, true, "持续期间结束日期")){
			return false;
		}
	}


	if(!compareDate(document.frmPost.txtCreateTime3,document.frmPost.txtCreateTime4,"持续期间结束日期必须大于等于持续期间开始日期")){
...
<form name="frmPost" method="post" action="campaign_catch_stat.do">
...
<td class="list_bg2"><div align="right">所在区域</div></td>
  ...
  <tr>
    <td class="list_bg2"><div align="right">捕获时间</div></td>
    <td class="list_bg1">
    ...
    <td class="list_bg2"><div align="right">持续期间</div></td>
    <td class="list_bg1">
	...
	<tr align="center">
	  <td class="list_bg1"><table  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<pri:authorized name="campaign_catch_stat_excel.do" >
			<td width="22" height="20">
			<td width="11" height="20"><img src="img/button_l.gif" width="11" height="20"></td>
			<td><input name="Submit" type="button" class="button" value="保存结果" onclick="javascript:save_query_result('促销活动捕获统计',true)"></td>
			<td width="22" height="20"><img src="img/button_r.gif" width="22" height="20"></td>
			</pri:authorized>
		  </tr>
	  </table></td>
...
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg" id="inTable">
	<tr class="list_head">
		<td class="list_head" nowrap><div align="center">机构/区域</div></td>
<%
	
	 Map mapShow = Postern.getCampaignNameAndID("campaign");
