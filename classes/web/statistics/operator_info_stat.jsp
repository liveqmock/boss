...
function query_submit(){
	document.frmPost.action="operator_info_stat.do";
	if(checkDate()){  
...
<%
	Map opGroupMap=Postern.getOpGroup();
	pageContext.setAttribute("OPGROUPMAP",opGroupMap);
%>
<form name="frmPost" method="post" action="operator_info_stat.do">
...
<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
  ...
  <tr>
    ...
    <td class="list_bg2"><div align="right">所属操作员组</div></td>
    <td class="list_bg1"><d:selcmn  name="txtOpGroupID" set="OPGROUPMAP" match="txtOpGroupID" width="23" /></td>
  </tr>
	...
	<tr align="center">
	  <td class="list_bg1"><table  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<pri:authorized name="operator_info_stat_excel.do" >
			<td width="22" height="20">
			<td width="11" height="20"><img src="img/button_l.gif" width="11" height="20"></td>
			<td><input name="Submit" type="button" class="button" value="保存结果" onclick="javascript:save_query_result('操作员统计',true)"></td>
			<td width="22" height="20"><img src="img/button_r.gif" width="22" height="20"></td>
			</pri:authorized>
		  </tr>
	  </table></td>
...
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg" id="inTable">
	<tr class="list_head">
		<td class="list_head"><div align="center">组织机构</div></td>
<%
	
	Map mapShow = Postern.getHashKeyValueByName("SET_G_GENERALSTATUS");
