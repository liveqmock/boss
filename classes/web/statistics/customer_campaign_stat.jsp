...
function query_submit(){
	document.frmPost.action="customer_campaign_stat.do";
	if(checkDate()){ 
...
<form name="frmPost" method="post" action="customer_campaign_stat.do">
...
<!--按照区域统计 写死-->
<input type="hidden" name="selStatType" value="D">
<table width="822">
<table  border="0" align="center" cellpadding="0" cellspacing="10" >
  <tr>
    <td><img src="img/list_tit.gif" width="19" height="19"></td>
    <td class="title">客户促销活动统计</td>
  </tr>
</table>
...
<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
  ...
  <tr>
  	<td class="list_bg2"><div align="right">促销活动状态</div></td>
    <td class="list_bg1"><d:selcmn  name="txtStatus" mapName="SET_M_CUSTOMERCAMPAIGNSTATUS" match="txtStatus" width="23" /> </td>
	...
	<tr align="center">
	  <td class="list_bg1"><table  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<pri:authorized name="customer_campaign_stat_excel.do" >
			<td width="22" height="20">
			<td width="11" height="20"><img src="img/button_l.gif" width="11" height="20"></td>
			<td><input name="Submit" type="button" class="button" value="保存结果" onclick="javascript:save_query_result('客户促销活动统计',true)"></td>
			<td width="22" height="20"><img src="img/button_r.gif" width="22" height="20"></td>
			</pri:authorized>
		  </tr>
	  </table></td>
...
<%
	...
	Map mapShow = Postern.getMealNameByType(CommonKeys.CAMPAIGNCAMPAIGNTYPE_NORMAL);
