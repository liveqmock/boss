    ...
    <td height="313" align="center" valign="top" bgcolor="#ECECEC" style="background:url(img/login_pic2.gif) bottom right no-repeat #ECECEC; "><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <table width="100%"  border="0" cellspacing="10" cellpadding="0">
          <tr>
            <td colspan="2" class="orange">用户名或密码不正确！</td>
            </tr>
          <tr>
            <td width="50">用户名</td>
            <td><input name="txtLoginID" type="text" class="text" style="width:150px;" onkeydown="NameReturnClick()"></td>
          </tr>
          <tr>
            <td>密&nbsp;&nbsp;码</td>
            <td><input name="txtLoginPwd" type="password" class="text" style="width:150px;" onkeydown="ReturnClick()"></td>
          </tr>
        </table>
            ...
            <tr align="center">
              <td><table  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td><input type="submit" class="button" onClick="javascript:OnEnter()" value="登 录"></td>
