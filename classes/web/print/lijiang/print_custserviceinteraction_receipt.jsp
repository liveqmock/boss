...
<lgc:bloop requestObjectName="ResponseQueryResult" item="oneline" > 
 <%
     String fapiaoDaimaStr="";
     String fapiaoHaomaStr="";
...
<TR height="150">
   ...
   <TD width="600" align="center" colspan="7">
    ...
    <TD>
        <!--20140222 增加发票打印-->
    <SPAN style="FONT-SIZE: 9pt; FONT-FAMILY: 楷体_GB2312"><%=validDate%><%fapiaoDaimaStr=acctItemDto.getFapiaoSerialNo();fapiaoHaomaStr=acctItemDto.getFapiaoHaoma();%></SPAN>
    </TD>
    </TR>
    ...
    %>
         <%
             if(fapiaoDaimaStr!=null&&fapiaoDaimaStr.length()>0){%>
         <tr> <SPAN style="FONT-SIZE: 9pt; FONT-FAMILY: 楷体_GB2312">发票代码:<%=fapiaoDaimaStr%> 发票号码:<%=fapiaoHaomaStr%>(如果与右上角发票代码号码不一致,发票无效)</SPAN></tr>
         <%  } %>
     <TR>
      <TD colspan="3">
