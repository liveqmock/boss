...
<br>
<form name="frmPost" method="post" action="job_card_query_result_for_contact_of_install.do" >
...
%>
		<tr class="list_bg1" onmouseover="this.className='list_over'" onmouseout="this.className='list_bg1'">
      	...
      	<td align="center"><a href="javascript:view_detail_click('<tbl:write name="oneline" property="JobCardId"/>')" class="link12" >安装时间预约</a></td>
    </tr>
</lgc:bloop>
  <tr>
