...
function check_form(){
  ...
  if (document.frmPost.txtCreateTimeBegin.value != ''){
		if (!check_TenDate(document.frmPost.txtCreateTimeBegin, true, "起始日期")){
			return false;
		}
...
{
	self.location.href="device_batchMatch_detail.do?txtBatchId="+strId;	
...
<table  border="0" align="center" cellpadding="0" cellspacing="10" >
  <tr>
    ...
    <td class="title">机顶盒/智能卡批量配对记录查询</td>
  </tr>
</table>
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" background="img/line_01.gif">
  <tr>
   ...
   <form name="frmPost" method="post" action="device_batchMatch_query_result.do" >
     <table width="100%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg"> 
<%
    
    Map mapDeviceModels = Postern.getAllDeviceModelsForSTBOrSC();
    pageContext.setAttribute("AllDeviceModels",mapDeviceModels);
    
    Map matchOperationType = Postern.getAllPreMatch();
    pageContext.setAttribute("MatchOperationType",matchOperationType);
...
%> 
      <tr >
        ...
        <td class="list_bg1" width="33%">
        	<tbl:select name="txtDeviceModel" set="AllDeviceModels" match="txtDeviceModel" width="23"/>
        </td>  
     ...
     <tr> 
                        ...
                        <td class="list_bg1" colspan="3"><font size="2"> 
                        	<tbl:select name="txtOperationType" set="MatchOperationType" match="txtOperationType" width="23"/>
