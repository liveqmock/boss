...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
	         ...
	         <tr>
           <td colspan="6" class="import_tit" align="center"><font size="3">设备预授权明细</font></td>
        </tr> 
	...
	<br>
	 ...
	 <table border="0" cellspacing="0" cellpadding="0" align=center>
        <tr>
        	   ...
        	   <bk:canback url="device_batchPreAuth_query_result.do">
        	   	
        	   	
           <td><img src="img/button2_r.gif" width="22" height="20"></td>
                <td background="img/button_bg.gif"><a href="<bk:backurl property="device_batchPreAuth_query_result.do" />" class="btn12">返&nbsp;回</a></td>
