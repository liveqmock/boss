...
function send_messenge_click(strBatchNo)
{
  //链接到批量发送消息任务创建页
	self.location.href="batchJob_for_send_message.do?txtBatchNo="+strBatchNo+"&txtJobType=SM";
}
...
<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0" background="img/line_01.gif">
  <tr>
   ...
   <form name="frmPost" method="post" action="batch_send_message_query.do" >
...
%>
  ...
  <tr class="list_bg1" onmouseover="this.className='list_over'" onmouseout="this.className='list_bg1'">
      ...
      <%if(batchID==0){%>
      <pri:authorized name="batchJob_for_send_message.do">
      <a href="javascript:send_messenge_click('<tbl:write name="oneline" property="batchNo"/>')" class="link12" >发送消息</a>
      </pri:authorized>
      <%}%>
      <br>
      </td>
      ...
      <td align="center" nowrap>
      <pri:authorized name="batch_send_message_query.export">
