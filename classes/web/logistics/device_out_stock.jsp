...
function check_frm()
{
	...
	if (check_Blank(document.frmPost.txtOrgID, true, "出库到组织"))
		return false;		
...
<form name="frmPost"  method="post" action="device_out_stock.do">    
   ...
   <tr>
	...
	<td class="list_bg1" colspan="3" align="left">
	  ...
	  <font size="2" color="red">&nbsp;&nbsp;扫描后按回车</font>
        </td>	   
      </tr> 
	 ...
	 <td class="list_bg1" colspan="3" align="left">
	 <div id="modelFieldNameDesc" style="color:red">序列号以“回车”隔开</div>
