...
<%
	String product_list = request.getParameter("txtProductIDListValue");
...
{
	document.frmPost.action="device_match.do";
	document.frmPost.submit();
} 
</script>
...
<form name="frmPost" action="device_match_confirm.do" method="post" >    
...
<%if(product_list.length()>0){%>
	<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
	    <tr>
		<td class="list_bg2" align="right" >预授权的产品</td>
		<td class="list_bg1" width="70%">
		<textarea name="txtProductIDListValue" cols="95" rows="1" value="<%=product_list %>" readonly class="textareashow"><tbl:writeparam name="txtProductIDListValue" /></textarea>
		</td>
	    </tr>
	</table>
<%}%>
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
   ...
   <tbl:hiddenparameters pass="txtDesc/txtPreAuth/txtProductIDList/txtSerialNoCollection/txtBatchID" />
   <tbl:generatetoken />
</form>  
