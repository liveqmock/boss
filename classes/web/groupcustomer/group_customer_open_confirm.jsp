...
function back_submit(){
	document.frmPost.action="group_customer_open_pay.screen";
	document.frmPost.txtActionType.value="openInfo";
	document.frmPost.confirm_post.value="false";
  document.frmPost.submit();
}
function next_submit(){
	document.frmPost.action="group_customer_open_confirm.do";
  document.frmPost.submit();
}
</SCRIPT>
...
<TABLE border="0" cellspacing="0" cellpadding="0" width="820">
	<TR>
	    ...
	    <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0" background="img/line_01.gif">
	      <tr>
			...
			<form name="frmPost" method="post">
				<input type="hidden" name="txtActionType" value="openConfirm">
        ...
        <tbl:generatetoken />
        		...
        		<tr>
        			<td> 
          			<tbl:CommonFeeAndPaymentInfo includeParameter="Fee_PayAndPrep" payCsiType="<%=CommonKeys.CUSTSERVICEINTERACTIONTYPE_GS%>" acctshowFlag ="false"   confirmFlag="true" />
        			</td>
        		</tr> 
      		</table>
			</form>
			...
			<table align="center" border="0" cellspacing="0" cellpadding="0" height="20">
					<tr height="20">
						...
						<td height="20"><input name="next" type="button" class="button" onClick="javascript:next_submit()" value="确　认"></td>
