...
<table align="center" width="100%" border="0" cellspacing="1" cellpadding="3" class="list_bg" >
      ...
      <tr class="list_head">
         ...
         <td width="20%" class="list_head" align="center">开户套餐活动名称</td>
         <td width="20%" class="list_head" align="center">套餐活动时间</td>
         <td width="50%" class="list_head" align="center">套餐活动具体内容</td>
      </tr>
      <%
      ...
      %>
         <tbl:printcsstr style1="list_bg1" style2="list_bg2" overStyle="list_over" >
           ...
           <td align="center" >
              ...
              <tbl:checkbox name="listID1"  value="oneline:campaignID" match="OpenCampaignList"  multipleMatchFlag="true" onclick="<%=clickName%>" />
           </td>
