...
abstract public class AitSetOffRuleBean implements EntityBean {
	...
	public java.lang.Integer ejbCreate(AitSetOffRuleDTO dto)
			throws CreateException {
	...
	public void ejbPostCreate(AitSetOffRuleDTO dto) throws CreateException {
		/** @todo Complete this method */
	}
