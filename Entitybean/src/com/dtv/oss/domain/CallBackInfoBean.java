...
abstract public class CallBackInfoBean implements EntityBean {
	...
	public java.lang.Integer ejbCreate(CallBackInfoDTO dto)
			throws CreateException {
	...
	public void ejbPostCreate(CallBackInfoDTO dto) throws CreateException {
		/** @todo Complete this method */
	}
