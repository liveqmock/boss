...
import com.dtv.oss.service.dao.network.VOIPCmdLogDAO;
import com.dtv.oss.service.listhandler.ListHandlerException;
import com.dtv.oss.service.listhandler.ValueListHandler;

public class QueryVOIPCmdDetailHandler extends ValueListHandler {
	private VOIPCmdProDTO dto=null;
	private final String tableName=" t_ssif_cmd_his a, t_ssif_command b ";
	private VOIPCmdLogDAO dao=null;
	
	public QueryVOIPCmdDetailHandler() {
		this.dao=new VOIPCmdLogDAO();
	}
	...
	private void constructSelectQueryString(VOIPCmdProDTO dto) {
		...
		selectStatement.append(" where a.cmdid=b.commandid ");
	  	this.makeSQLByIntField("seqno",dto.getSeqNo(),selectStatement);
