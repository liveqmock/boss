...
public class ServiceAccountForScheduleListHandler extends ValueListHandler {
	...
	public ServiceAccountForScheduleListHandler() {
  	...
  	private void constructSelectQueryString(CustomerProductDTO dto) {
		...
		makeSQLByStringField("pd.productclass", CommonConstDefinition.PRODUCTCLASS_SOFTWARE , selectStatement);
