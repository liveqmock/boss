...
import com.dtv.oss.service.dao.batch.FoundCustomerDAO;
...
public class FoundCustomerDetailListHandler  extends ValueListHandler {

	private CommonQueryConditionDTO dto = null;
    private FoundCustomerDAO dao=null;
    private static final Class clazz=FoundCustomerDetailListHandler.class;
    final private String tableName ="t_foundcustomerhead head,t_foundcustomerdetail detail";
    
    public FoundCustomerDetailListHandler(){
    	this.dao =new FoundCustomerDAO();
    }
    ...
    private void constructSelectQueryString(CommonQueryConditionDTO dto2) throws ListHandlerException {
		...
		selectStatement.append(" where 1=1 and head.batchNo =detail.batchNo and head.status='成功' ");
