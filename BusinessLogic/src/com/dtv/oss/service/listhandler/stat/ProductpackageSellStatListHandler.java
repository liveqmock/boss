...
public class ProductpackageSellStatListHandler extends ValueListHandler {
		...
		public ProductpackageSellStatListHandler(){
		...
		sqlShow.append("select csipro.ReferPackageID subname,count(distinct csipro.csiid) amount");
		...
		sqlGroup.append(" group by csipro.ReferPackageID");
		...
		if (!(dto.getSpareStr5() == null || "".equals(dto.getSpareStr5()))) {
			sqlTable.append(",T_ProductPackage propac");
			sqlWhere.append(" and csipro.ReferPackageID=propac.PackageID");
			sqlWhere.append(" and propac.PackageClass='" + dto.getSpareStr5() + "'");
			}
