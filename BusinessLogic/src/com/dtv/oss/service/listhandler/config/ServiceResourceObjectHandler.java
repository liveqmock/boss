...
public class ServiceResourceObjectHandler extends ValueListHandler {
	private ServiceResourceDAO dao = null;

	public ServiceResourceObjectHandler() {
	...
	private void constructSelectQueryString(ServiceResourceDTO dto) {
		...
		where.append(" and resourcename='").append(dto.getResourceName())
				.append("'");
		// 设置构造取得当前查询总纪录数的sq
