...
public class ConfigPaymentTypeQueryListHandler extends ValueListHandler {
	private GenericDAO dao = null;

	public ConfigPaymentTypeQueryListHandler() {
		dao = new ConfigCustomerValueDao();
	}

	public void setCriteria(Object dto) throws ListHandlerException {
		LogUtility.log(ConfigPaymentTypeQueryListHandler.class, LogLevel.DEBUG,
