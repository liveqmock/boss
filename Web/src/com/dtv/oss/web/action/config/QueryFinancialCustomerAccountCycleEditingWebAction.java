 ...
 */
public class QueryFinancialCustomerAccountCycleEditingWebAction extends
		QueryWebAction {
	...
	public EJBEvent perform(HttpServletRequest request)
		...
		if (actionType != null
				&& EDITING_TYPE_UPDATE.equals(actionType = actionType.trim())) {
	...
	protected EJBEvent encapsulateData(HttpServletRequest request)
		...
		if (editingType != null
			...
			setCustomerAccountCycleType(dto, request);
			QueryFinancialSettingEJBEvent ejbEvent = new QueryFinancialSettingEJBEvent(
					0, 1);
			ejbEvent.setDto(dto);
			ejbEvent
					.setType(QueryFinancialSettingEJBEvent.QUERY_CUSTOMER_ACCOUNT_CYCLE_DETAIL);
			return ejbEvent;
		}
		return null;
	}
	...
	// String firstValidInvoiceCycleId =
	// (String)request.getParameter("txtFirstValidInvoiceCycleId");
	// String rentDisctMode = (String)request.getParameter("txtRentDisctMode");
