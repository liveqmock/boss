 ...
 */
public class QueryFinancialAccountCycleTypeEditingWebAction extends
		QueryWebAction {
	/**
	...
	protected EJBEvent encapsulateData(HttpServletRequest request)
		...
		if (editingType != null
			...
			ejbEvent
					.setType(QueryFinancialSettingEJBEvent.QUERY_ACCOUNT_CYCLE_TYPE_DETAIL);
			return ejbEvent;
		}
		return null;
	}
	...
	// String actionType = (String)request.getParameter("ACTION_TYPE");
	//		
	// if(actionType!=null|| ACTION_TYPE_UPDATE.equals(actionType =
	// actionType.trim())){
	// BillingCycleTypeDTO bctDto = new BillingCycleTypeDTO();
	// setChargeCycleType(bctDto,request);
	...
	// ejbEvent.setDto(bctDto);
	// ejbEvent.setType(QueryFinancialSettingEJBEvent.QUERY_ACCOUNT_CYCLE_TYPE_DETAIL);
	// }
	// return null;
	// QueryFinancialSettingEJBEvent ejbEvent = new
	// QueryFinancialSettingEJBEvent();
	// int actionType = QueryFinancialSettingEJBEvent.QUERY_GENERAL_SETTING;
	//
	...
	// .getAttribute("txtCalculatedPunishmentFlag");
