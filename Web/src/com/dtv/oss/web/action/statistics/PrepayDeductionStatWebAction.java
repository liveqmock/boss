...
public class PrepayDeductionStatWebAction extends QueryWebAction {
	...
	protected EJBEvent encapsulateData(HttpServletRequest request)
		...
		return new StatQueryEJBEvent(theDTO,pageFrom,pageTo,StatQueryEJBEvent.QUERY_TYPE_STAT_PREPAYDEDUCTION);
	}
