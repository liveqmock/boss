 ...
 *
 */
public class CustomerSAStatWebAction extends QueryWebAction {
...
//			dto.setSpareStr2(request.getParameter("txtOrgID"));
		...
		if(WebUtil.StringHaveContent(request.getParameter("txtServiceType")))
			dto.setSpareStr5(request.getParameter("txtServiceType"));
//		//SpareStr6:订户状态
//		if(WebUtil.StringHaveContent(request.getParameter("txtServiceStatus")))
//			dto.setSpareStr6(request.getParameter("txtServiceStatus"));
		//SpareTime1:创建时间1
		...
		return new StatQueryEJBEvent(dto,pageFrom,pageTo,StatQueryEJBEvent.QUERY_TYPE_STAT_CUSTOMERSA);
	}
