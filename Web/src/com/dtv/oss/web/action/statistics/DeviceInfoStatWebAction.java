 ...
 *
 */
public class DeviceInfoStatWebAction extends QueryWebAction {
	...
	protected EJBEvent encapsulateData(HttpServletRequest request)
		...
		return new StatQueryEJBEvent(dto,pageFrom,pageTo,StatQueryEJBEvent.QUERY_TYPE_STAT_DEVICE_INFO);
	}
