 ...
 *
 */
public class AcctBankMatchStatWebAction extends QueryWebAction {
	...
	protected EJBEvent encapsulateData(HttpServletRequest request)
		...
		return new StatQueryEJBEvent(dto,pageFrom,pageTo,StatQueryEJBEvent.QUERY_TYPE_STAT_ACCOUNT_BANK_MATCH);
	}
