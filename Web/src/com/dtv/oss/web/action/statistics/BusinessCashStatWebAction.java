...
public class BusinessCashStatWebAction extends QueryWebAction {
...
//		组织和区域不同同时被选择
		...
		return new StatQueryEJBEvent(theDTO,pageFrom,pageTo,StatQueryEJBEvent.QUERY_TYPE_STAT_BUSINESS_CASH);
	}
