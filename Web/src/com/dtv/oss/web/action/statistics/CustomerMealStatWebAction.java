 ...
 *
 */
public class CustomerMealStatWebAction extends QueryWebAction {
	...
	protected EJBEvent encapsulateData(HttpServletRequest request)
		...
		//	dto.setSpareStr6(request.getParameter("selSortType"));
		//else
		//	throw new WebActionException("分类方式错误:分类方式字段不能为空！");
		...
		return new StatQueryEJBEvent(dto,pageFrom,pageTo,StatQueryEJBEvent.QUERY_TYPE_STAT_CUSTOMERMEAL);
	}
