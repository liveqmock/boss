...
public class CatvRegisterJobCardWebAction extends PayFeeWebAction{
    ...
    protected EJBEvent encapsulateData(HttpServletRequest request) 
       throws WebActionException{
        ...
        if("batch".equals(request.getParameter("txtActionType")))
        {
       	 ...
       	 jcEjbEvent.setActionType(EJBEvent.BATCH_CATV_REGISTER_INSTALLATION_INFO);
       	 return  jcEjbEvent; 
        }
        //catv批量录入施工信息 end
         ...
         if(WebUtil.StringHaveContent(request.getParameter("txtReferSheetID")))
         	jcDto.setReferSheetId(WebUtil.StringToInt(request.getParameter("txtReferSheetID")));
         ...
         if(WebUtil.StringHaveContent(request.getParameter("txtSubType")))
         	jcDto.setSubType(request.getParameter("txtSubType"));
         ...
         jcEjbEvent.setActionType(EJBEvent.CATV_REGISTER_JOBCARD);
         ...
         System.out.println(jcEjbEvent.getActionType());
         return  jcEjbEvent;        
