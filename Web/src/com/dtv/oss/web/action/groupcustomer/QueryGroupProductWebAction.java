...
public class QueryGroupProductWebAction extends QueryWebAction{
	...
	protected EJBEvent encapsulateData(HttpServletRequest request) throws Exception {
		...
		return new GroupCustomerQueryEJBEvent(dto,pageFrom,pageTo,QueryGroupCustomerEJBEvent.QUERY_GROUP_PRODUCTLIST);
	}
