...
public class ContactUserForInstallWebAction extends GeneralWebAction {
	protected EJBEvent encapsulateData(HttpServletRequest request)
		...
		if("batch".equals(request.getParameter("txtActionType")))
		{
			...
			jcEvent.setActionType(EJBEvent.BATCH_CONTACT_USER_FOR_INSTALLATION);
		...
		jcEvent.setActionType(EJBEvent.CONTACT_USER_FOR_INSTALLATION);
