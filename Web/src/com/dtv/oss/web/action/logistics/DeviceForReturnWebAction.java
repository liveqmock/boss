...
public class DeviceForReturnWebAction extends GeneralWebAction{
  ...
  protected EJBEvent encapsulateData(HttpServletRequest request) throws WebActionException
    {
        ...
        theDTO.setToID(WebUtil.StringToInt(request.getParameter("txtDepotID")));
        ...
        event.setActionType(LogisticsEJBEvent.DEVICE_IN_STOCK);
