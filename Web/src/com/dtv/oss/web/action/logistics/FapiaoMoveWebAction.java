 ...
 * 发票调拨
 */
public class FapiaoMoveWebAction extends GeneralWebAction {
	...
	protected EJBEvent encapsulateData(HttpServletRequest request)
		...
		if (!WebUtil.StringHaveContent(request.getParameter("txtDepotID")))
			throw new WebActionException("参数错误:调拨到的仓库未知!");
		...
		theEvent.setActionType(LogisticsEJBEvent.FAPIAO_MOVE);
