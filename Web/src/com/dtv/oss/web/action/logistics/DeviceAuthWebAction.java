...
public class DeviceAuthWebAction extends GeneralWebAction {
    ...
    protected EJBEvent encapsulateData(HttpServletRequest request) throws WebActionException{
	     ...
	     event.setActionType(LogisticsEJBEvent.DEVICE_PREAUTH);
	     try {
		   if (!doPost){
			   ...
			   ArrayList deviceCheckList=FileUtility.pareXlsFiletoDevice(filePath,"Y");
