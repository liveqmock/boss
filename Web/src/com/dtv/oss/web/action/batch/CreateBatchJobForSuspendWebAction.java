...
public class CreateBatchJobForSuspendWebAction extends GeneralWebAction {
	protected EJBEvent encapsulateData(HttpServletRequest request)
		...
		try {
			...
			dto.setReasonCode(request.getParameter("txtReasonCode"));
			...
			//设置动作类型
			event.setActionType(EJBEvent.BATCH_SUSPEND_CREATEJOB);
		} catch (Exception e) {
			e.printStackTrace();
