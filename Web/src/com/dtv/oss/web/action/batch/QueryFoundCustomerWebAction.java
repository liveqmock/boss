...
public class QueryFoundCustomerWebAction extends QueryWebAction{
	...
	protected EJBEvent encapsulateData(HttpServletRequest request) throws Exception {
	    ...
	    return new QueryBatchEJBEvent(dto,pageFrom,pageTo,QueryBatchEJBEvent.QUERY_FOUNDCUSTOMER_DETAIL);
	}
