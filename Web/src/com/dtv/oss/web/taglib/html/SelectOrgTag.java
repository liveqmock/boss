 ...
 *
 */
public class SelectOrgTag extends SelectTag {
	 ...
	 public int doStartTag() throws JspException {
        ...
        mapKeyValue=Postern.getOrgTreeByOrgID(dtoOper.getOrgID());
//        LogUtility.log(this.getClass(),LogLevel.WARN,"取得的orgTree" +mapKeyValue);
