...
function view_detail(strId){
	var strUrl="account_cycle_type_editing.do?editing_type=view_update&txtId="+strId;
...
function create_config_submit() {   
	var strUrl="account_cycle_type_editing.do?editing_type=new";
   self.location.href=strUrl;
}
...
<table width="820" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td>
		<form name="frmPost" method="post" action="account_cycle_type_brief.do" > 
			<table  border="0" align="center" cellpadding="0" cellspacing="10">
  				<tr>
    				<td><img src="img/list_tit.gif" width="19" height="19"></td>
    				<td  class="title">配置帐务周期类型</td>
  				</tr>
  			</table>
			<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0" background="img/line_01.gif">
 				...
 				<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
         			<tr class="list_head">
           				...
           				<td class="list_head">第一个有效的周期 </td>
        			</tr>
					<rs:hasresultset>
					...
					%>
	 				<tr class="list_bg1" onmouseover="this.className='list_over'" onmouseout="this.className='list_bg1'">
	     				<td align="center"><a href="javascript:view_detail('<tbl:write name="oneline" property="id"/>')" class="link12" >
      	     			...
      	     			<td align="center"><d:getcmnname  typeName="BillingCycleTypeObjects" match="oneline:billingCycleTypeId"/></td> 
    			...
    			<input type="hidden" name="txtTo" size="20" value="10"/>
  				...
  				<table align="center" border="0" cellspacing="0" cellpadding="0">
        			<tr>
          				...
          				<td background="img/button_bg.gif"><a href="javascript:create_config_submit()" class="btn12">新增记帐周期类型</a></td>
