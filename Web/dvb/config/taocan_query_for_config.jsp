...
function check_form(){
            ...
            if (!check_TenDate(document.frmPost.txtDateTo, true, "截止时间"))
            {
                
        	return false;	
            }
            if(!compareDate(document.frmPost.txtDateFrom,document.frmPost.txtDateTo,"截止时间必须大于等于起始时间")){
...
function create_campaign_submit() {
   ...
   document.frmPost.action="campaign_create_for_config.screen";
   document.frmPost.submit();
}
...
<form name="frmPost" method="post" action="taocan_query.do" >
 
 
   <table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
      
        <tr> 
          <td  class="list_bg2"><div align="right">套餐名称</div></td>         
    ...
    <input type="hidden" name="txtCampaignType" size="20" value="B">
...
<lgc:bloop requestObjectName="ResponseQueryResult" item="oneline" >
	 ...
	 <tr class="list_bg1" onmouseover="this.className='list_over'" onmouseout="this.className='list_bg1'">
       ...
       <td align="left"><tbl:write name="oneline" property="campaignName"/></td>
       <td align="center"><tbl:write name="oneline" property="campainpriority" /></td>	
