...
{
	self.location.href="machine_room_detail_config.do?txtID="+strId;
}
function create_submit()
{
	self.location.href="machine_room_create.screen";
}
...
<br>
<form name="frmPost" method="post" action="machineroom_query.do" >
   <table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
     <tr>
          <td class="list_bg2"><div align="right">机房编号</div></td>
          <td class="list_bg1"> 
            <input type="text" name="txtMachineRoomCode" maxlength="20" size="25" value="<tbl:writeparam name="txtMachineRoomCode" />" >
           </td>      
          
           <td  class="list_bg2"><div align="right">机房名称</div></td>
           <td class="list_bg1">
           <input type="text" name="txtMachineRoomName" maxlength="25" size="25" value="<tbl:writeparam name="txtMachineRoomName" />" >
         </td>
        </tr>
       <tr>
...
<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
         <tr class="list_head">
          ...
          <td class="list_head">机房编号</td>
          <td class="list_head">机房名称</td>
...
<lgc:bloop requestObjectName="ResponseQueryResult" item="oneline" >
		...
		<tr class="list_bg1" onmouseover="this.className='list_over'" onmouseout="this.className='list_bg1'">
		   ...
		   <td align="center"><tbl:write name="oneline" property="machineRoomCode"/></td>
		   <td align="center"><tbl:write name="oneline" property="machineRoomName"/></td>  
