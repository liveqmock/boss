...
function create_submit(){
  if (check_frm()){
	    document.frmPost.action="create_fiber_node.do";
...
<table width="810" align="center" border="0" cellspacing="1" cellpadding="3">
	<input type="hidden" name="func_flag" value="1038" > 
	...
	<tr>
		...
		<td class="list_bg1"><tbl:select name="txtFiberRecieverId" set="CODE" match="txtFiberRecieverId" width="23"/></td>
        </tr>
      <tr>
