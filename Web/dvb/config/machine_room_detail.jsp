...
function check_frm()
{
    ...
    if (check_Blank(document.frmPost.txtMachineRoomCode, true, "机房编号"))
	    return false;
...
function modify_submit(){
 if (window.confirm('您确认要修改该机房吗?')){
  if (check_frm()){
	    document.frmPost.action="config_modify_machineroom.do";
...
<form name="frmPost" method="post" >    
       ...
       <tr> 
         <td  class="list_bg2"><div align="right">记录ID</div></td>         
          <td class="list_bg1" align="left">
           ...
           <td class="list_bg2"><div align="right">机房编号*</div></td>
           <td class="list_bg1" align="left" >
            <input type="text" name="txtMachineRoomCode"   size="25"  maxlength="20"  value="<tbl:write name="oneline" property="machineRoomCode"/>" >
          
       </tr>
       <tr>
       <td class="list_bg2" align="right">机房名称</td>
            <td class="list_bg1" colspan="3">
    	    <input type="text" name="txtMachineRoomName"   size="25"    value="<tbl:write name="oneline" property="machineRoomName"/>" >
 ...
 <input type="hidden" name="func_flag" value="1042" >
 ...
 <table align="center" border="0" cellspacing="0" cellpadding="0">
        <tr>
         <td><img src="img/button2_r.gif" border="0" ></td>
          <td background="img/button_bg.gif"><a href="<bk:backurl property="machineroom_query.do" />" class="btn12">返&nbsp;回</a></td>
