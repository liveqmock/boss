...
function value_modify_submit(){
    ...
    if (check_frm()){
	    document.frmPost.action="swap_device_status_create.do";
...
<table  border="0" align="center" cellpadding="0" cellspacing="10" >
 <tr>
  ...
  <tr>
    ...
    <td class="title">设备更换状态管理记录创建</td>
  </tr>
</table>
...
<form name="frmPost" method="post" >   
 ...
 <table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
	   ...
	   <td class="list_bg1">
	   	<input name="txtReasonStrListValue" type="text" class="text" maxlength="200" size="25" value="<tbl:writeparam name="txtReasonStrListValue"/>" readonly >
	   	<input name="txtReasonStrList" type="hidden" value="<tbl:writeparam name="txtReasonStrList" />" >
	    ...
	    <td  class="list_bg2"><div align="right">目标状态*</div></td>
           <td class="list_bg1">
             <d:selcmn name="txtToStatus" mapName="SET_D_DEVICESTATUS" match="txtToStatus" width="23" />
