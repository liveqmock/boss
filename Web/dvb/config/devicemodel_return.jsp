...
<TABLE border="0" align="center" cellspacing="0" cellpadding="0"
	...
	<TR>
		...
		<form name="frmPost" method="post" action="devicemodel_query.screen">
		<table width="50%" border="0" align="center" cellpadding="0"
			cellspacing="10">
			<tr align="center">
				<td height="37">
				...
				case 101: //创建
					...
					%>
							...
							<td><input name="Submit22" type="button" class="button"
								onClick="javascript:frmSubmit('<bk:backurl property='devicemodel_create.do' />')"
								value="返回"></td>
				...
				case 102: //修改
					...
					%>
							<td width="11" height="20"><img src="img/button_l.gif" width="11"
								height="20"></td>
							<td><input name="Submit22" type="button" class="button"
								onClick="javascript:frmSubmit('<bk:backurl property='devicemodel_modify.do' />')"
								value="返回"></td>
							<td width="22" height="20"><img src="img/button_r.gif" width="22"
								height="20"></td>
			...
			%>
						...
						<td width="11" height="20"><img src="img/button_l.gif" width="11"
							height="20"></td>
						<td><input name="Submit22" type="button" class="button"
							onClick="javascript:frmSubmit('<bk:backurl property='devicemodel_query.do'/>')"
							value="返回到设备型号查询"></td>
						<td width="22" height="20"><img src="img/button_r.gif" width="22"
							height="20"></td>
					</tr>
