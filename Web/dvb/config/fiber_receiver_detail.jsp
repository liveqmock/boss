...
function check_frm()
{
    ...
    if (check_Blank(document.frmPost.txtFiberReceiverCode, true, "光接收机编号"))
	    return false;
    if (check_Blank(document.frmPost.txtFiberTransmitterId, true,9, "光发机编号"))
	    return false;  
...
function modify_submit(){
 if (window.confirm('您确认要修改该光接收机吗?')){
  if (check_frm()){
	    document.frmPost.action="config_modify_fiberreceiver.do";
...
<form name="frmPost" method="post" >   
 <lgc:bloop requestObjectName="ResponseQueryResult" item="oneline" > 
  <%
    ...
    Map receiverCode = Postern.getFiberTransmitterCodeMap();
...
%>
 ...
 <table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
       ...
       <tr> 
         <td  class="list_bg2"><div align="right">记录ID</div></td>         
          <td class="list_bg1" align="left">
           ...
           <td class="list_bg1" align="left" >
            <input type="text" name="txtFiberReceiverCode"   size="25"  maxlength="20"  value="<tbl:write name="oneline" property="fiberReceiverCode"/>" >
      ...
      <tr>
       ...
       <tr>
       <td class="list_bg2" align="right">光发机编号*</td>
            <td class="list_bg1" colspan="3">
               <tbl:select name="txtFiberTransmitterId" set="CODE" match="txtFiberTransmitterId" width="23" defaultValue="<%=idStr%>"/></td>	
       ...
       <tr>
          ...
          <input type="text" name="txtDescription" maxlength="100" size="84"   value="<tbl:write name="oneline" property="description"/>">
          </td>    
 ...
 <input type="hidden" name="func_flag" value="1046" >
 ...
 <table align="center" border="0" cellspacing="0" cellpadding="0">
        <tr>
         <td><img src="img/button2_r.gif" border="0" ></td>
          <td background="img/button_bg.gif"><a href="<bk:backurl property="fiberreceiver_query.do" />" class="btn12">返&nbsp;回</a></td>
