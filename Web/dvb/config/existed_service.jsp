...
<%
    ...
    List serviceList = Postern.getServiceByProduct(productId);
    if(serviceList!=null) 
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
         <tr class="list_head">
          ...
          <td class="list_head" width="20%"><div align="center">业务ID</div></td>
          <td class="list_head" width="30%"><div align="center">业务名称</div></td>
          <td class="list_head" width="45%"><div align="center">描述</div></td>
        </tr>
         <input type="hidden" name="txtServiceNum" value="<%=size%>"/>
<%
    String check = null;
    if (size > 0)
