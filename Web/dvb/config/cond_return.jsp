...
String hiddenValues=request.getParameter("txtHiddenValues");
			...
			String strActionUrl = "query_points_cond.do";


			if (sFlag != null) {
				if (sFlag.equalsIgnoreCase("cond_create")) {
					strErrBackUrl = "cond_create.screen";
					strErrButtonValue = "返回积分兑换条件新建";
					strBackUrl = "query_points_cond.do";
					strButtonValue = "返回兑换条件列表";
				} else if (sFlag.equalsIgnoreCase("cond_update")) {
					strErrBackUrl = "cond_detail.do";
					strErrButtonValue = "返回积分兑换条件修改";
					strBackUrl = "query_points_cond.do";
					strButtonValue = "返回兑换条件列表";
				} else if (sFlag.equalsIgnoreCase("cond_delete")) {
					strErrBackUrl = "query_points_cond.do";
					strErrButtonValue = "返回兑换条件列表";
					strBackUrl = "query_points_cond.do";
					strButtonValue = "返回兑换条件列表";
				} else {
