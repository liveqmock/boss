...
{
	self.location.href="fiber_transmitter_detail_config.do?txtID="+strId;
}
function create_submit()
{
	self.location.href="fiber_transmitter_create.screen";
}
...
<br>
<form name="frmPost" method="post" action="fibertransmitter_query.do" >
   <table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
     <tr>
          <td class="list_bg2"><div align="right">光发射机编号</div></td>
          <td class="list_bg1"> 
            <input type="text" name="txtFiberTransmitterCode" maxlength="50" size="25" value="<tbl:writeparam name="txtFiberTransmitterCode" />" >
           </td>      
          
           <td  class="list_bg2"><div align="right">机房名称</div></td>
           <td class="list_bg1">
           <tbl:select name="txtMachineRoomId" set="CODE" match="txtMachineRoomId" width="23"/></td>
 ...
 <%
	...
	int fiberReceiverId=dto.getMachineRoomId();						
        ...
        if(receiverCode!=null)
         recCode=(String) receiverCode.get(String.valueOf(fiberReceiverId));
        if(recCode==null)
          recCode="";
  ...
  %>
		<tr class="list_bg1" onmouseover="this.className='list_over'" onmouseout="this.className='list_bg1'">
		   ...
		   <td align="center"><tbl:write name="oneline" property="fiberTransmitterCode"/></td>
