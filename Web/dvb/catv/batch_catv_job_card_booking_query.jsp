...
function jobcard_batch_submit(){	
    ...
    if(checkSelected()){
	   if (check_frm()){
			document.frmPost.action="batch_catv_job_card_booking.do";
			document.frmPost.submit();
	    }
    }
}
...
<br>
<form name="frmPost" method="post" action="batch_catv_job_card_booking_query.do" >
...
<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
	  ...
	  <td class="list_bg1"><table  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			<td width="11" height="20"><img src="img/button_l.gif" width="11" height="20"></td>
			<td><input name="Submit" type="button" class="button" value="施工时间预约" onclick="javascript:jobcard_batch_submit()"></td>
			<td width="22" height="20"><img src="img/button_r.gif" width="22" height="20"></td>
		  </tr>
	  </table></td>
	</tr>
