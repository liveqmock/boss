...
<br>
<form name="frmPost" method="post" action="catv_job_card_query_result_for_contact_of_install.do" >
...
%>
	...
	<!--	    <td align="center"><o:getcmnname typeName="SET_V_CUSTSERVICEINTERACTIONTYPE" match="<%=type%>" /></td>-->
      	...
      	<td align="center"><a href="javascript:view_detail_click('<tbl:write name="oneline" property="JobCardId"/>')" class="link12" >施工时间预约</a></td>
    </tr>
</lgc:bloop>
  <tr>
