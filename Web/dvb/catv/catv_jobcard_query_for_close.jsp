...
<br>
<form name="frmPost" method="post" action="catv_query_result_for_close.do" >
...
<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
         <tr class="list_head">
          ...
          <td class="list_head" nowrap>预约上门时间</td> 
...
%>
		<tr class="list_bg1" onmouseover="this.className='list_over'" onmouseout="this.className='list_bg1'">
		    <td align="center"><tbl:writenumber name="oneline" property="JobCardId" digit="7" /></a></td>
		     <td align="center"><tbl:writedate name="oneline" property="dtCreate"  includeTime="false"/><br><tbl:writedate name="oneline" property="dtCreate"  onlyTime="true"/></td>
      		    ...
      		    <td align="center"><a href="javascript:view_detail_click('<tbl:write name="oneline" property="JobCardId"/>')" class="link12" >结束施工</a></td>
    		</tr>
