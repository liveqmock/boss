...
function frm_submit1(csipaymentOption){
	var csi_payment_option_im ='<%=CommonKeys.CSI_PAYMENT_OPTION_IM%>';
  if (check_frm()&& check_Bidimconfig()){
	   ...
	   if (csi_payment_option_im ==csipaymentOption){
	   	  document.frmPost.txtDoPost.value ="false";
        document.frmPost.action ="catv_register_of_install_success_fee.do";
     } else{
     	  document.frmPost.action ="catv_register_update.do";
     }
...
function frm_submit2(){
   if (check_frm() && check_Bidimconfig()){
	    if (check_Blank(document.frmPost.txtWorkResultReason, true, "施工失败原因"))
		      return;
 ...
 <table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
   <tr>
	...
	<input type="text" name="txtJobType" size="25"  value="<o:getcmnname typeName="SET_W_JOBCARDTYPE" match="oneline:jobType"/>" class="textgray" readonly   >
	  ...
	  <td class="list_bg1"  > 
			<input type="text" name="subType" size="25"  value="<o:getcmnname typeName="SET_W_JOBCARDSUBTYPE" match="oneline:subType"/>" class="textgray" readonly   >
			<input type="hidden" name="txtSubType" value="<tbl:write name="oneline"   property="subType" />"/>
	</td>
	</tr> 
	...
	<input type="text" name="txtAddPortNumber" size="25"  value="<tbl:write name="oneline" property="addPortNumber" />" class="textgray" readonly   >
	  ...
	  <td class="list_bg1"  > 
			<input type="text" name="txtDtCreate" size="25"  value="<tbl:writedate name="oneline"   property="dtCreate" includeTime="true"/>" class="textgray" readonly   >
	</td>
	</tr>
	 ...
	 <tr>
		<td class="list_bg2" align="right" width="17%">施工人员*</td>
	 ...
	 <tr>
		<td class="list_bg2" align="right" width="17%">施工成功描述</td>
		<td class="list_bg1" colspan="3" align="left" width="83%"> 
			<input type="text" name="txtMemo" size="83" maxlength="200" value="<tbl:writeparam name="txtMemo" />">
		</td>
	</tr>
	<tr>
		<td class="list_bg2" align="right" width="17%">施工失败原因</td>
		<td class="list_bg1" align="left"  width="33%"> 
	...
	<tr>
		<td class="list_bg2" align="right" width="17%">施工失败描述</td>
		<td class="list_bg1" colspan="3" align="left" width="83%"> 
			<input type="text" name="txtFaildComment" size="83" maxlength="200" value="">
		</td>
	</tr> 
<%if("W".equals(wrap.getJobCardDto().getSubType())){%>
<tbl:dynamicservey  serveyType="U"  serveySubType="MU" showType="text" tdWordStyle="list_bg2" tdControlStyle="list_bg1" controlSize="23" tdWidth1="17%" tdWidth2="33%" defaultFlag="true" checkScricptName ="check_Bidimconfig()"/>  
<%}else{%>
<tbl:dynamicservey serviceID="<%=serviceID%>" serveyType="U"  serveySubType="MU" showType="text" tdWordStyle="list_bg2" tdControlStyle="list_bg1" controlSize="23" tdWidth1="17%" tdWidth2="33%" defaultFlag="true" checkScricptName ="check_Bidimconfig()"/>  
<%}%>
 ...
 <table align="center" border="0" cellspacing="0" cellpadding="0">
 	<tr> 
       ...
       <td background="img/button_bg.gif"><a href="<bk:backurl property="catv_jobcard_query_result_for_register.do/job_card_view.do" />" class="btn12">返&nbsp;回</a></td>           
       <td><img src="img/button2_l.gif" width="11" height="20"></td>
       <td width="20" ></td>
       <td><img src="img/button_l.gif" border="0" ></td>
       <td background="img/button_bg.gif"  ><a href="javascript:frm_submit1('<%=csiDto.getBillCollectionMethod()%>')" class="btn12">施工成功</a></td>
       <td><img src="img/button_r.gif" border="0" ></td>
       <td width="20"></td>
       <td><img src="img/button_l.gif" border="0" ></td>
       <td background="img/button_bg.gif"  >
	         <a href="javascript:frm_submit2()" class="btn12">施工失败</a></td>
       <td><img src="img/button_r.gif" border="0" ></td>           
    </tr>    
  </table>    
  </lgc:bloop>
