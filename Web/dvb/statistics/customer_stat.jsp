...
function query_submit(){
	document.frmPost.action="customer_stat.do";
	if(checkDate()){ 
...
<form name="frmPost" method="post" action="customer_stat.do">
...
<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
  ...
  <tr>
    ...
    <td class="list_bg1"><d:selcmn name="txtOpenSourceType" match="txtOpenSourceType" mapName="SET_C_CUSTOPENSOURCETYPE" width="23" onchange="ChangeOpenSourceType()" />
    </td>
    </tr>
  
  <tr>
    <td class="list_bg2"><div align="right">来源渠道ID</div></td>
    <td class="list_bg1"><d:selopensourceid name="txtOpenSourceID" parentMatch="txtOpenSourceType" match="txtOpenSourceID" width="23" />
    </td>
	...
	<tr align="center">
	  <td class="list_bg1"><table  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<pri:authorized name="customer_stat_excel.do" >
			<td width="22" height="20">
			<td width="11" height="20"><img src="img/button_l.gif" width="11" height="20"></td>
			<td><input name="Submit" type="button" class="button" value="保存结果" onclick="javascript:save_query_result('客户数统计',true)"></td>
			<td width="22" height="20"><img src="img/button_r.gif" width="22" height="20"></td>
			</pri:authorized>
		  </tr>
	  </table></td>
...
Map mapShow = Postern.getHashKeyValueByName("SET_C_CUSTOMERTYPE");
Map mapSecSub = Postern.getHashKeyValueByName("SET_C_CUSTOMERSTATUS");
...
%>
		...
		<tr class="list_head">
			...
			for(int k=0;k<colCount;k++){
				...
				allValue = new long[colCount][secSubCount];
			%>
		<tr>
		...
		for (int i=0;i<colCount;i++)
		{
				...
				for(int j=0;j<secSubCount;j++)
				{
					...
					if(mapValueMulti != null)
					{
					  ...
					  {
							dValue = Math.round(Double.parseDouble((String)mapValueMulti.get(secSubKeyList.get(j)))*10)/10;
