...
function query_submit(){
	document.frmPost.action="product_sell_stat.do";
	if(checkDate()){ 
...
<form name="frmPost" method="post" action="product_sell_stat.do">
...
<td class="list_bg2"><div align="right">客户类型</div></td>
  ...
  <tr>	 
   ...
   <tr>	 
   	...
   	<%pageContext.setAttribute("businessTypeMap", Postern.getAllService());%>
    <td class="list_bg1">
    	<tbl:select name="txtBusinessType" set="businessTypeMap" match="txtBusinessType" width="23" /></td> 
    </td>
    <td class="list_bg2"><div align="right">产品类型</div></td>
    <td class="list_bg1"><d:selcmn  name="txtProductType" mapName="SET_P_PRODUCTCLASS" match="txtProductType" width="23" />
    </td>
  </tr>
  
  <tr>
  	 <td class="list_bg2"><div align="right">产品状态</div></td>
		<td class="list_bg1"><d:selcmn  name="txtProductStatus" mapName="SET_P_PRODUCTSTATUS" match="txtProductStatus" width="23" /></td>	
	...
	<tr align="center">
	  <td class="list_bg1"><table  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<pri:authorized name="product_sell_stat_excel.do" >
			<td width="22" height="20">
			<td width="11" height="20"><img src="img/button_l.gif" width="11" height="20"></td>
			<td><input name="Submit" type="button" class="button" value="保存结果" onclick="javascript:save_query_result('产品销售统计',true)"></td>
			<td width="22" height="20"><img src="img/button_r.gif" width="22" height="20"></td>
			</pri:authorized>
		  </tr>
	  </table></td>
...
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg" id="inTable">
	<tr class="list_head">
		<td class="list_head" nowrap><div align="center">区域/组织</div></td>
<%
	Map mapShow = Postern.getAllSellProductMap(request.getParameter("txtBusinessType"),request.getParameter("txtProductType"));
