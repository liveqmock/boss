...
function query_submit(){
	document.frmPost.action="call_back_stat.do";
	if(checkDate()){ 
...
function checkDate(){
	...
	if(!compareDate(document.frmPost.txtCreateTime1,document.frmPost.txtCreateTime2,"创建结束日期必须大于等于创建开始日期")){
		...
		if (!check_TenDate(document.frmPost.txtCreateTime3, true, "回访开始日期")){
			return false;
		}
	}
	if (document.frmPost.txtCreateTime4.value != ''){
		if (!check_TenDate(document.frmPost.txtCreateTime4, true, "回访结束日期")){
			return false;
		}
	}


	if(!compareDate(document.frmPost.txtCreateTime3,document.frmPost.txtCreateTime4,"回访结束日期必须大于等于回访开始日期")){
  	...
  	if (check_Blank(document.frmPost.selStatType, true, "统计方式"))
		return false;
		if (check_Blank(document.frmPost.txtCallBackFlag, true, "回访标志"))
		return false;
...
<form name="frmPost" method="post" action="call_back_stat.do">
...
<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
  <tr>
    ...
    <td class="list_bg1"><d:selcmn  name="txtCallBackFlag" mapName="SET_C_CPCALLBACKFLAG" match="txtCallBackFlag" width="23" /> </td>
  </tr>
  ...
  <tr>	 
    ...
    <td class="list_bg2" align="right">组织</td>
   		 <td class="list_bg1">
   ...
   <tr>	 
   	<td class="list_bg2"><div align="right">安装方式</div></td>
   	 <td class="list_bg1" colspan="3"><d:selcmn  name="txtInstallationType" mapName="SET_V_CUSTSERVICEINTERACTIONINSTYPE" match="txtInstallationType" width="23" /> </td>
  </tr>
  ...
  <tr>
    ...
    <td class="list_bg2"><div align="right">回访时间</div></td>
    <td class="list_bg1">
	...
	<tr align="center">
	  <td class="list_bg1"><table  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<pri:authorized name="call_back_stat_excel.do" >
			<td width="22" height="20">
			<td width="11" height="20"><img src="img/button_l.gif" width="11" height="20"></td>
			<td><input name="Submit" type="button" class="button" value="保存结果" onclick="javascript:save_query_result('开户回访统计',true)"></td>
			<td width="22" height="20"><img src="img/button_r.gif" width="22" height="20"></td>
			</pri:authorized>
		  </tr>
	  </table></td>
...
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg" id="inTable">
	<tr class="list_head">
		<td class="list_head" nowrap><div align="center">组织/区域</div></td>
<%
	Map mapShow = Postern.getHashKeyValueByName("SET_V_CUSTSERVICEINTERACTIONSTATUS"); 
	double allValue[];
	int colCount = 0;
	if (mapShow != null)
	{
