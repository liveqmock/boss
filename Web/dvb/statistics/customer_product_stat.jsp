...
<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
  ...
  <tr>
    <td class="list_bg2"><div align="right">订户类型</div></td>
  ...
  <tr>
  	<td class="list_bg2"><div align="right">本次统计产品<br/>(默认为全部)</div></td>
    	...
    	<textarea name="txtCPProductIDListValue" cols="82" rows="2"  readonly class="textareashow"><tbl:writeparam name="txtCPProductIDListValue" /></textarea>
	   	...
	   	<input name="checkbutton" type="button" class="button" value="选择" onClick="javascript:open_select('PRODUCT','txtCPProductIDList',document.frmPost.txtCPProductIDList.value,'','','')"> 
    	</td>
  </tr>
  <tr>
    <td class="list_bg2"><div align="right">产品类别</div></td>
	...
	<tr align="center">
	  <td class="list_bg1"><table  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<td width="11" height="20"><img src="img/button_l.gif" width="11" height="20"></td>
			<td><input name="Submit" type="button" class="button" value="保存结果" onclick="javascript:save_query_result('客户产品统计',true)"></td>
			<td width="22" height="20"><img src="img/button_r.gif" width="22" height="20"></td>
			</pri:authorized>
		  </tr>
	  </table></td>
...
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg" id="inTable">
	<tr class="list_head">
		<td class="list_head" width="2%" rowspan="2" nowrap><div align="center">区域</div></td>
			<%
			...
			%>
		<td class="list_head" width="4%" rowspan="2" nowrap><div align="center">总计</div></td>
	</tr>
	<tr class="list_head">
			<%
			int maxNum = 0;
