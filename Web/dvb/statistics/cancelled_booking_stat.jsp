...
function query_submit(){
	document.frmPost.action="cancelled_booking_stat.do";
	if(checkDate()){  
...
<form name="frmPost" method="post" action="cancelled_booking_stat.do">
...
<td class="list_bg2"><div align="right">区域</div></td>
  ...
  <tr>
    ...
    <td class="list_bg1"><d:selcmn  name="txtOpenSourceType" mapName="SET_C_CUSTOPENSOURCETYPE" match="txtOpenSourceType" width="23" /></td>
  </tr>
	...
	<tr align="center">
	  <td class="list_bg1"><table  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<pri:authorized name="cancelled_booking_stat_excel.do" >
			<td width="22" height="20">
			<td width="11" height="20"><img src="img/button_l.gif" width="11" height="20"></td>
			<td><input name="Submit" type="button" class="button" value="保存结果" onclick="javascript:save_query_result('预约取消统计',true)"></td>
			<td width="22" height="20"><img src="img/button_r.gif" width="22" height="20"></td>
			</pri:authorized>
		  </tr>
	  </table></td>
...
<%
	...
	//Map mapShow = Postern.getHashKeyValueByName("SET_V_CUSTSERVICEINTERACTIONSTATUSREASON");
	Map mapShow = Postern.getCsiReasonByCon("BK","C","V");//预约取消
