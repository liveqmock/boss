...
<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
  <tr>
    ...
    <td class="list_bg1"><d:selcmn  name="txtDeviceClass" set="DEVICECLASSES" match="txtDeviceClass" width="23" /> 
...
<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
	<tr align="center">
	<pri:authorized name="device_info_stat_excel.do" >
	  <td class="list_bg1"><table  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			<td width="11" height="20"><img src="img/button_l.gif" width="11" height="20"></td>
			<td><input name="Submit" type="button" class="button" value="保存结果" onclick="javascript:save_query_result('设备统计',true)"></td>
			<td width="22" height="20"><img src="img/button_r.gif" width="22" height="20"></td>
		  </tr>
	  </table></td>
	  </pri:authorized>
...
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg" id="inTable">
	<tr class="list_head">
		<td class="list_head"><div align="center">设备型号</div></td>
<%
	Map unSortMapShow=Postern.getHashKeyValueByName("SET_D_DEVICESTATUS");
	if(unSortMapShow == null)  unSortMapShow = new HashMap();
	Map mapShow=new TreeMap();
	mapShow.putAll(unSortMapShow);
...
<lgc:bloop requestObjectName="ResponseQueryResult" item="oneline" >
	<tbl:printcsstr style1="list_bg1" style2="list_bg2" overStyle="list_over" > 
      	<td align="center" class="t12"><tbl:write name="oneline" property="id"/>
      		<!--
      		<d:getcmnname typeName="DEVICECLASSES" match="oneline:id" />
      		-->
      	</td>
<%
