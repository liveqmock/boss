...
function query_submit(){
	document.frmPost.action="business_account_item_stat.do";
	if(checkDate()){  
...
<form name="frmPost" method="post" action="business_account_item_stat.do">
...
<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
  ...
  <tr>
    ...
    <td class="list_bg1"><d:selcmn  name="txtFeeType" mapName="SET_F_BRFEETYPE" match="txtFeeType" width="23" />
     ...
     <td class="list_bg2"><div align="right">帐单标记</div></td>
    <td class="list_bg1"><d:selcmn  name="txtInvoicedFlag" mapName="SET_G_YESNOFLAG" match="txtInvoicedFlag" width="23" />
    </td>
   </tr>
   	
   <tr>
   	<td class="list_bg2"><div align="right">单据类型</div></td>
    <td class="list_bg1"><d:selcmn  name="txtReferType" mapName="SET_F_FTREFERTYPE" match="txtReferType" width="23" />
    </td>
	...
	<tr align="center">
	  <td class="list_bg1"><table  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<pri:authorized name="business_account_item_stat_excel.do" >
			<td width="22" height="20">
			<td width="11" height="20"><img src="img/button_l.gif" width="11" height="20"></td>
			<td><input name="Submit" type="button" class="button" value="保存结果" onclick="javascript:save_query_result('营业费用统计',true)"></td>
			<td width="22" height="20"><img src="img/button_r.gif" width="22" height="20"></td>
			</pri:authorized>
		  </tr>
	  </table></td>
