...
function query_submit(){
	document.frmPost.action="customer_meal_stat.do";
	if(checkDate()){  
...
<form name="frmPost" method="post" action="customer_meal_stat.do">
...
<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
  ...
  <tr>
  	<td class="list_bg2"><div align="right">套餐状态</div></td>
	...
	<tr align="center">
	  <td class="list_bg1"><table  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<pri:authorized name="customer_meal_stat_excel.do" >
			<td width="22" height="20">
			<td width="11" height="20"><img src="img/button_l.gif" width="11" height="20"></td>
			<td><input name="Submit" type="button" class="button" value="保存结果" onclick="javascript:save_query_result('客户套餐统计',true)"></td>
			<td width="22" height="20"><img src="img/button_r.gif" width="22" height="20"></td>
			</pri:authorized>
		  </tr>
	  </table></td>
...
<%
	...
	Map mapShow = Postern.getMealNameByType(CommonKeys.CAMPAIGNCAMPAIGNTYPE_OPEN);
