...
<%
    ...
    mapPsPackageStatus.put("V","有效");
    mapPsPackageStatus.put("I","无效");
...
<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
  ...
  <tr>
    ...
    <td class="list_bg2"><div align="right">客户产品包状态</div></td>
    <td class="list_bg1">
    <tbl:select name="txtPsPackageStatus" set="mapPsPackageStatus" match="txtPsPackageStatus" width="23"/>
		</td>	
  </tr>
  <tr>
  	<td class="list_bg2"><div align="right">本次统计产品包<br/>(默认为全部)</div></td>
    	...
    	<textarea name="txtPsPackageIDListValue" cols="82" rows="2"  readonly class="textareashow"><tbl:writeparam name="txtPsPackageIDListValue" /></textarea>
	   	...
	   	<input name="checkbutton" type="button" class="button" value="选择" onClick="javascript:open_select('PACKAGE','txtPsPackageIDList',document.frmPost.txtPsPackageIDList.value,'','','')"> 
    	</td>
  </tr>
  <tr>
  	<td class="list_bg2"><div align="right">产品包类别</div></td>
	...
	<tr align="center">
	  <td class="list_bg1"><table  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<td width="11" height="20"><img src="img/button_l.gif" width="11" height="20"></td>
			<td><input name="Submit" type="button" class="button" value="保存结果" onclick="javascript:save_query_result('客户产品包统计',true)"></td>
			<td width="22" height="20"><img src="img/button_r.gif" width="22" height="20"></td>
			</pri:authorized>
		  </tr>
	  </table></td>
