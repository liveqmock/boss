...
<TABLE width="660" align="center">
    <TR>
        <TD align="center">
            <B><SPAN style="FONT-SIZE: 14pt; FONT-FAMILY: 黑体; mso-hansi-font-family: 宋体">丽江市有线电视帐单</SPAN></B>
        </TD>
    </TR>
</TABLE>
...
<TR>
    ...
    <SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 楷体_GB2312">节目订购信息</SPAN>
    </TD>
    <TD  align="center" width="210"  style="border-right:1 solid black;border-bottom:1 solid black">
    <SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 楷体_GB2312">产品名称(频道号)</SPAN>
    </TD>
    <TD  align="center" width="130"  style="border-right:1 solid black;border-bottom:1 solid black">
    <SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 楷体_GB2312">订购价格</SPAN>
    </TD>
    <TD align="center" width="130" style="border-right:1 solid black;border-bottom:1 solid black">
    <SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 楷体_GB2312">订购期限</SPAN>
    </TD>
     <TD align="center" width="180"  style="border-bottom:1 solid black">
    <SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 楷体_GB2312">订购起始日期</SPAN>
    </TD>
</TR>
<TR>
    <TD height="400" width="650" colspan="4">
		...
		<%		
			     ...
			     ProductPackageDTO productPackageDTO =  Postern.getProductPackageByPackageID(packageID.intValue());
			     String description=productPackageDTO.getDescription();
				 if(description==null)description="";
		%>
	        <TD height="10"  align="center" width="130" >
            <SPAN  style="FONT-SIZE: 12pt; FONT-FAMILY: 楷体_GB2312"><%=description%><BR></SPAN>
            </TD>
            <TD height="10" align="center" width="130">
            <SPAN   style="FONT-SIZE: 12pt; FONT-FAMILY: 楷体_GB2312"><BR></SPAN>
            </TD>
