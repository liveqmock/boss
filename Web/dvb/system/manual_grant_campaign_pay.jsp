...
<%--$Id: manual_grant_campaign_pay.jsp,v 1.1.1.1 2010/01/25 09:11:16 yangyong Exp $--%>
...
<table border="0" align="center" cellpadding="0" cellspacing="10">
	<tr>
		...
		<td class="title">手工授予促销活动-支付信息</td>
	</tr>
</table>
...
<form name="frmPost" method="post"
	action="manual_grant_campaign_confirm.screen">
...
<tbl:CommonFeeAndPaymentInfo includeParameter="Fee_PayAndPrep"
	...
	acctshowFlag="true" confirmFlag="false" checkMoneyFlag="2"/>
<table align="center" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td><input name="Submit" type="button" class="button" value="下一步"
			onclick="javascript:button_next()"></td>
