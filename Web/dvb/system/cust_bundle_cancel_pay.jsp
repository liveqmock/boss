...
<form name="frmPost" method="post" action="" >
     ...
     <tr>
      ...
      <tbl:CommonFeeAndPaymentInfo includeParameter="Fee_Pay" payCsiType="<%=CommonKeys.CUSTSERVICEINTERACTIONTYPE_BDC%>" acctshowFlag ="true" confirmFlag="false" checkMoneyFlag="2"/>		 
