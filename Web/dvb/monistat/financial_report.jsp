    ...
    function check_form(){
	  ...
	  function out_submit(){ 
	 	  if (check_form()){
	  	   ...
	  	   window.open('financial_report_excel.do?pageCode=financial_report_excel&txtAct=out'+tempValue,'',
...
<table  border="0" align="center" cellpadding="0" cellspacing="10">
  <tr>
    ...
    <td class="title">收看维护费缴费及结转账收入汇总</td>
  </tr>
</table>
...
<br>
<form name="frmPost" method="post" action="financial_report.do" >
   ...
   <table width="810"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
    ...
    <table width="810"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
       <tr class="list_head">
         	...
         	<td class="list_head" >本期收费金额 </td>
          <td class="list_head" >退费金额 </td> 
          <td class="list_head" >本期实收金额 </td> 
          <td class="list_head" >本期应计入收入金额 </td>        
          <td class="list_head" >上期应转入本期收入金额 </td>
          <td class="list_head" >本期收入合计</td>
          <td class="list_head" >上期预存余额</td>
          <td class="list_head" >本期预存余额</td>
       </tr>
