...
{
     document.frmPost.action="device_out_stock_comfirm.do";
    document.frmPost.submit();    
}
function back_submit()
{
	document.frmPost.action="menu_device_out_stock.do" ;
	document.frmPost.submit();
}
...
<table  border="0" align="center" cellpadding="0" cellspacing="10" >
  <tr>
    ...
    <td class="title"><font size="3">设备出库库信息确认</font></td>
  </tr>
</table>
 ...
 <form name="frmPost" method="post" >    
  <table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">  
   <input type="hidden" name="confirm_post" value="true">
    <input type="hidden" name="func_flag" value="1112">
   ...
   <tr> 
    ...
    %>
    <td class="list_bg2" width="20%"><div align="right">出库到组织</td>
    <td class="list_bg1">
        <input type="text" name="txtOrgName" size="25"  class="textgray" readonly value="<%=orgName%>" >
        </td>
    </tr>    
    <tr>
      <td class="list_bg2" width="20%"><div align="right">备注</div></td>
...
<% 
    String deviceStr=request.getParameter("txtSerialNoCollection");
    if(deviceStr==null)deviceStr="";
    String deviceList[]=deviceStr.split("\r\n");
    Map mapDepots = Postern.getAllDepot();
    
    for(int i=0;i<deviceList.length;i++){
    
    	TerminalDeviceDTO  terDevDto = Postern.getTerminalDeviceBySerialNo(deviceList[i]);
...
%>
 ...
 <%}%> 
     <tr>
      <td class="list_bg2" align="right" colspan="8">总共<%=deviceList.length%>条记录</td>
    </tr>
   ...
   <tbl:hiddenparameters pass="txtBatchNo/txtOrgID/txtSerialNoCollection" />
   <tbl:generatetoken />
</form>  
