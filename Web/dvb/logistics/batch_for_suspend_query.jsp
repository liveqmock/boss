...
function suspend_click(strBatchNo)
{
  //链接到批量关断任务创建页
	self.location.href="batchJob_for_suspend.do?txtBatchNo="+strBatchNo+"&txtJobType=US";
}
...
<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0" background="img/line_01.gif">
  <tr>
   ...
   <form name="frmPost" method="post" action="batch_for_suspend_query.do" >
...
%>
  ...
  <tr class="list_bg1" onmouseover="this.className='list_over'" onmouseout="this.className='list_bg1'">
      ...
      <%if(batchID==0){%>
      <pri:authorized name="batchJob_for_suspend.do">
      <a href="javascript:suspend_click('<tbl:write name="oneline" property="batchNo"/>')" class="link12" >关断</a>
      </pri:authorized>
      <%}%>
      <br>
      </td>
      ...
      <td align="center" nowrap>
      <pri:authorized name="batch_for_suspend_query.export">
