...
function scrap_create()
{
     document.frmPost.action="device_scrap_confirm.do";
    document.frmPost.submit();    
}
function back_submit()
{
  document.frmPost.confirm_post.value = "false";
	document.frmPost.action="menu_device_scrap.do" ;
	document.frmPost.submit();
}
...
<table  border="0" align="center" cellpadding="0" cellspacing="10" >
  <tr>
    ...
    <td class="title"><font size="3">设备报废信息确认</font></td>
  </tr>
</table>
 ...
 <form name="frmPost" method="post" >    
  <table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">  
   <input type="hidden" name="confirm_post" value="true">
    <input type="hidden" name="func_flag" value="1113">
   ...
   <tr> 
    ...
    <tr>
      <td class="list_bg2"><div align="right">备注</div></td>
        <td class="list_bg1" colspan="3">
        <input type="text" name="txtComments" size="83" class="textgray" readonly value="<tbl:writeparam name="txtComments" />" >          
      </td>
     </tr>    
 ...
 <%}%> 
    ...
    <table border="0" cellspacing="0" cellpadding="0" align=center>
		...
		<td width="20"></td>           	
            ...
            <td background="img/button_bg.gif"><a href="javascript:scrap_create()" class="btn12">确认</a></td>
   ...
   <tbl:hiddenparameters pass="txtBatchNo/txtSerialNoCollection" />
   <tbl:generatetoken />
</form>  
