...
function back_submit(){
	 document.frmPost.action="group_customer_open_info.do";
...
function frm_next(csiPayOption){
	 ...
	 if (check_fee()){
	    document.frmPost.action="group_customer_open_pay.screen";
	 	  ...
	 	  document.frmPost.txtActionType.value="openConfirm";
	...
	<TR>
        ...
        <input type="hidden" name="txtcsiPayOption" >  
		  	...
		  	<tbl:generatetoken />
        		...
        		<tr>
        			<td> 
          			<tbl:CommonFeeAndPaymentInfo includeParameter="Fee" payCsiType="<%=CommonKeys.CUSTSERVICEINTERACTIONTYPE_GS%>" acctshowFlag ="false" />
        			</td>
        		</tr> 
      		</table>
			</form>
