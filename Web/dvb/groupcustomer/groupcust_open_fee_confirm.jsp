...
<script language=javascript>
	...
	function groupcust_open(){
		//支付确认提交
		document.all.frmPost.action="groupcust_open.do";
		document.all.frmPost.submit(); 
	}
</script>
...
<table align="center" width="100%" border="0" cellspacing="1" cellpadding="3" class="list_bg" >
    <tr ><td> 
       <tbl:CommonFeeAndPaymentInfo includeParameter="Fee_PayAndPrep" payCsiType="<%=CommonKeys.CUSTSERVICEINTERACTIONTYPE_GO%>" acctshowFlag ="true" confirmFlag="true" />	
    </td></tr> 
</table>
<tbl:generatetoken />
  <br>
 <table align="center"  border="0" cellspacing="0" cellpadding="0">
      <tr>  
        	<td><img src="img/button2_r.gif" width="22" height="20"></td>
	   		...
	   		<td background="img/button_bg.gif"><a href="javascript:groupcust_open()" class="btn12">确 认</a></td> 
