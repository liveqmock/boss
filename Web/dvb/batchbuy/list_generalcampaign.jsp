...
//			.getpackagecondByCampaignID(campaignDto.getCampaignID());
	...
	<tbl:printcsstr style1="list_bg1" style2="list_bg2" overStyle="list_over">
		...
		<td align="center">
			...
			<input type="hidden" name="listCampaignName" value="<tbl:write name="oneline" property="campaignName" />">
			<tbl:checkbox name="listID4" value="oneline:campaignID" match="GeneralCampaignList" multipleMatchFlag="true"
				onclick="<%=clickName%>" />
		</td>
		<td align="center">
