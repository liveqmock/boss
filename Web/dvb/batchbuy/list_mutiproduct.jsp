...
<table align="center" width="100%" border="0" cellspacing="1" cellpadding="3" class="list_bg">
	<tr class="list_head">
		...
		<td width="40%" class="list_head" align="center">
			产品包名称
		</td>
		<td width="10%" class="list_head">
			&nbsp;
	...
	<tbl:printcsstr style1="list_bg1" style2="list_bg2" overStyle="list_over">
		<input type="hidden" name="listMPackageName" value="<tbl:write name="oneline" property="packageName" />">
		<td align="center">
			<tbl:checkbox name="listID2" value="oneline:packageID" match="MutiProductList" multipleMatchFlag="true" />
		</td>
		<td align="center">
			<a
