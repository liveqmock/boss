...
function jobcard_print_submit(){	
    ...
    if(checkSelected()){
		...
		{
			document.frmPost.action="gehua_in_jobcard_batch_print_for_catv.do?titleDemo=安装";	
			document.frmPost.txtTo.value = 500;
		}	
		document.frmPost.submit();
		document.all.actiontype.value="query";
		document.frmPost.action="in_job_card_query_for_print_result.do";
...
<br>
<form name="frmPost" action="in_job_card_query_for_print_result.do" method="post" >    
<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
  <tr>
    <td class="list_bg2" align="right">安装单编号</td>
  ...
  <tr>
   ...
   <tr>
     ...
     <td class="list_bg1" align="left">
     	   <d:selcmn name="txtOpenSourceType" match="txtOpenSourceType" mapName="SET_C_CUSTOPENSOURCETYPE" width="25" onchange="ChangeOpenSourceType()" />
     </td>  
    </tr>
    <tr>
