...
<form name="frmPost" method="post" action="" >
 ...
 <table align="center" border="0" cellspacing="0" cellpadding="0">
    <tr> 
       ...
       <td background="img/button_bg.gif"><a href="<bk:backurl property="pi_query_result_for_register.do/job_card_view.do" />" class="btn12">返&nbsp;回</a></td>           
       <td><img src="img/button2_l.gif" width="11" height="20"></td>
       <td width="20" ></td>
       <td><img src="img/button_l.gif" border="0" ></td>
       <td background="img/button_bg.gif"  ><a href="javascript:frm_submit1('')" class="btn12">确&nbsp;认</a></td>
