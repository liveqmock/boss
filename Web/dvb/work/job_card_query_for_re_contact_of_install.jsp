...
<br>
<form name="frmPost" method="post" action="job_card_query_result_for_re_contact_of_install.do" >
 <input type="hidden" name="actiontype" value="reinstall">
   <table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
     ...
     <table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
      ...
      <input type="hidden" name="txtStatus"  value="B;F">
...
<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
         <tr class="list_head">
          ...
          <td class="list_head" width="9%" nowrap>相关受理单类型</td>
          <td class="list_head" width="10%" nowrap>联系人</td>
          <td class="list_head" width="12%" nowrap>联系电话</td>
          <td class="list_head" width="17%" nowrap>联系地址</td>
          <td class="list_head" width="14%" nowrap>所在区域</td>
          <td class="list_head" width="9%" nowrap>状态</td>
		...
		<tr class="list_bg1" onmouseover="this.className='list_over'" onmouseout="this.className='list_bg1'">
		        ...
		        <td align="center" ><a href="<%=url%>?txtID=<tbl:write name="oneline" property="ReferSheetId"/>" class="link12" >
		         ...
		         <td align="center"><o:getcmnname typeName="SET_V_CUSTSERVICEINTERACTIONTYPE" match="<%=type%>" /></td>
      			...
      			<td align="center"><a href="javascript:view_detail_click('<tbl:write name="oneline" property="JobCardId"/>')" class="link12" >重预约</a></td>
    		</tr>
<%
    type = null;
    url = null;
