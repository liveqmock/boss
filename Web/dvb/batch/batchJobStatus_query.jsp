...
function query_submit()
{
    if (check_form())
    {
    	document.frmPost.txtJobType.value = document.frmPost.txtBatchJobType.value;
    	document.frmPost.txtActionType.value = "batch";
        document.frmPost.action = "batchJobStatus_query_result.do";
...
function view_batchjob_detail(strID)
{
    ...
    document.frmPost.submit();
//    location.href = "batchJob_query_detail.do?txtBatchID="+strID+"&txtActionType=result";
}
</SCRIPT>

<form name="frmPost" method="post" action="batchJobStatus_query_result.do" >
<input type="hidden" name="txtActionType" size="20" value="batch">
<input type="hidden" name="txtJobType" size="20" value="<tbl:writeparam name="txtBatchJobType"/>">
...
<table width="810" align="center" border="0" cellspacing="1" cellpadding="3">
	...
	<tr>
		...
		<td class="list_bg1"><d:selcmn name="txtBatchJobType" mapName="SET_B_BATCHJOBTYPE"  match="txtBatchJobType"  width="23" /></td>
	</tr>
	<tr>
     	...
     	<input onfocus="viewModule(this)" onKeydown="inputDate(document.frmPost.txtActionEndDate)" onblur="lostFocus(this)" name="txtActionEndDate" type="text" class="text" maxlength="10" size="10" value="<tbl:writeparam name="txtActionEndDate" />">		<IMG onclick="MyCalendar.SetDate(this,document.frmPost.txtActionEndDate,'Y')" src="img/calendar.gif" style=cursor:hand border="0">
   		...
   		<td class="list_bg1" width="33%"><d:selcmn name="txtScheduleType" mapName="SET_B_SCHEDULETYPE"  match="txtScheduleType"  width="23" /></td>
	</tr>
	<tr>
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
	...
	<tbl:printcsstr style1="list_bg1" style2="list_bg2" overStyle="list_over" >
	    <td><tbl:write name="BatchJobDTO" property="batchId"/></a></td>
	    <td><tbl:write name="BatchJobDTO" property="Name"/></td>  
	    <td><tbl:writedate name="BatchJobDTO" property="createTime" /></td>
	    <td><%=strOpName %></td>
	    <td><d:getcmnname typeName="SET_B_BATCHJOBTYPE" match="BatchJobDTO:jobType" /></td>
