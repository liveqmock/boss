...
<%@ page import="com.dtv.oss.dto.FoundCustomerDetaiDTO" %>
...
<br>
<form name="frmPost" method="post" action="foundCustomer_query.do">
...
<table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
  <tr class="list_head">
    ...
    <td class="list_head" width="5%" >收费终端数</td>
    <td class="list_head" width="5%" >客户类型</td>
    <td class="list_head" width="10%" >产品名称</td>
    <td class="list_head" width="10%" >报装时间</td>
    <td class="list_head" width="10%" >安装完成时间</td>
    <td class="list_head" width="6%" >光缆入网费</td>
    <td class="list_head" width="6%" >收视费</td>
    <td class="list_head" width="8%" >电话</td>
  </tr>
<%
...
<lgc:bloop requestObjectName="ResponseQueryResult" item="oneline" >
   <%
     FoundCustomerDetaiDTO dto = (FoundCustomerDetaiDTO)pageContext.getAttribute("oneline");
     DistrictSetting dt =(DistrictSetting)Postern.getAllDistrictSettingCache().get(""+dto.getDistrinctId());
		 ...
		 String productName =(String)proMap.get(""+dto.getProductId());
		 
   %>
   <tbl:printcsstr style1="list_bg1" style2="list_bg2" overStyle="list_over" >
     <td align="center" ><tbl:writedate name="oneline" property="dt_createTime"/></td>
     ...
     <td align="center" ><tbl:write name="oneline" property="serviceAccountCount" /></td>
     <td align="center" ><%=custType%></td>
     <td align="center" ><%=productName%></td>
     <td align="center" ><tbl:writedate name="oneline" property="createTime" /></td>
     <td align="center" ><tbl:writedate name="oneline" property="installTime" /></td>
     <td align="center" ><tbl:write name="oneline" property="oncepaymoney" /></td>
     <td align="center" ><tbl:write name="oneline" property="prePaymoney" /></td>
