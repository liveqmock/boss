...
<form name="frmPost" method="post" action="ca_eventcmdmap_op.do">
	<!-- 定义当前操作 -->
	<input type="hidden" name="txtActionType" size="20" value="CA_EVENTCMDMAP_CREATE">
...
<table width="100%" align="center" border="0" cellspacing="1"
	...
	<tr>
		...
		<td class="list_bg1"><font size="2"><d:selcmn name="txtStatus"
			mapName="SET_G_GENERALSTATUS" match="oneline:status" width="23" defaultValue="V"/> </font></td>
	...
	<tr align="center">
	  ...
	  <table align="center"  border="0" cellspacing="0" cellpadding="0">
         <tr>  
            ...
            <td><input name="Submit" type="button" class="button"
					value="保&nbsp;存" onclick="javascript:ca_eventcmdmap_create()"></td>
