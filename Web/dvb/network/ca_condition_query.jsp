...
%>
	...
	<table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="list_bg">
		<tr class="list_head">
			<td width="5%" nowrap class="list_head">条件ID</td>
			<td width="20%" nowrap class="list_head">条件名称 </td>
			<td width="10%" nowrap class="list_head">CA主机 </td>
			<td width="30%" nowrap class="list_head">条件内容 </td>
			<td width="35%" nowrap class="list_head">描述 </td>
		</tr>
	  ...
	  <table align="center"  border="0" cellspacing="0" cellpadding="0">
         <tr>  
            ...
            <td><input name="Submit" type="button" class="button"
					value="新&nbsp;增" onclick="javascript:ca_condition_create()"></td>
