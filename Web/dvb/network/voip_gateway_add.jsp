...
<form name="frmPost" method="post" action="voip_gateway_add.do">
...
<table width="810" align="center" border="0" cellspacing="1"
	...
	<tr>
		...
		<td class="list_bg1" width="33%"><font size="2"><tbl:select name="txtdeviceModel" set="devices" width="23" match="txtdeviceModel"/></font></td>
