...
<rs:hasresultset>
	<table width="100%" border="0" align="center" cellpadding="5"
		...
		<tr class="list_head">
			<td class="list_head"><P align="center">SMS产品ID</P></td>
			<td class="list_head"><P align="center">SMS产品名称</P></td>
			<td class="list_head"><P align="center">语音产品名称</P></td>
			<td class="list_head"><P align="center">语音服务编码</P></td>
			
			<td class="list_head"><P align="center">服务类型</P></td>
