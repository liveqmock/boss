...
<form name="frmPost" method="post" action="voip_condition_add.do">
...
<table width="810" align="center" border="0" cellspacing="1"
	...
	<tr>    
		...
		<td class="list_bg1"><input name="txtConditionID"
			...
			value="<tbl:writeparam name="txtConditionID" />"></td>
	...
	<tr>
	    ...
	    <textarea name="txtProductNameList" readonly length="5" cols=82 rows=4 ><tbl:writeparam name="txtProductNameList" /></textarea>
...
<table align="center"  border="0" cellspacing="0" cellpadding="0">
          <tr>  
            ...
            <td><input name="Submit" type="button" class="button"
					value="保&nbsp;存" onclick="javascript:add_submit()"></td>
