...
function back_submit(){
	 ...
	 document.frmPost.action="batchRenewProtocol_fee.do";
...
<form name="frmPost" action="batchRenewProtocol_op.do" method="post" > 
	<input type ="hidden" name="txtDoPost" value ="true" >
	<input type ="hidden" name="func_flag" value ="1114" >
...
<tbl:CommonFeeAndPaymentInfo includeParameter="Fee_PayAndPrep" payCsiType="<%=CommonKeys.CUSTSERVICEINTERACTIONTYPE_BDP%>"  confirmFlag="false" />	
<br>
<table width="100%">
<tr>
<td>
