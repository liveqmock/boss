   ...
   %>         
      ...
      <table align="center" width="820" border="0" cellspacing="1" cellpadding="3" class="list_bg" >
         ...
         <tr> 
            ...
            <td align="right" width="17%" class="list_bg2"><font size="2">新增端口数</font></td> 
...
%>         
      ...
      <table align="center" width="100%" border="0" cellspacing="1" cellpadding="3" class="list_bg" >
        <tr ><td> 
              <tbl:CommonFeeAndPaymentInfo includeParameter="Fee_PayAndPrep" payCsiType="<%=CommonKeys.CUSTSERVICEINTERACTIONTYPE_CAO%>" acctshowFlag ="false"  confirmFlag="false" />
        </td></tr> 
      </table>
