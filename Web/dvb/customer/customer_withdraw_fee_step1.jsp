...
function frm_submit(){
	if (check_fee()){
			document.frmPost.action="customer_withdraw_fee_step2.do";
	   	document.frmPost.submit();
	}    
}
//-->
...
<form name="frmPost" method="post" action="">
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="810">
	   <tr><td>
        <tbl:CommonFeeAndPaymentInfo includeParameter="CloseAcctFee_step1" payCsiType="<%=CommonKeys.CUSTSERVICEINTERACTIONTYPE_WC%>" checkMoneyFlag="2" />		 		
     </td></tr>
  </table>
  <br>
