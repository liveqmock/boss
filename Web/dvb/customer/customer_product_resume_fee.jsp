...
<form name="frmPost" method="post" action="customer_product_resume_confirm.screen" >     
     <table  border="0" align="center" cellpadding="0" cellspacing="5">
        <tr>
          <td><img src="img/list_tit.gif" width="19" height="19"></td>
          <td class="title">产品恢复--收费信息录入</td>
        </tr>
      </table>
      <br>
...
<tbl:CommonFeeAndPaymentInfo includeParameter="Fee_Pay" payCsiType="<%=CommonKeys.CUSTSERVICEINTERACTIONTYPE_RM%>" acctshowFlag ="true"  confirmFlag="false" />
<BR>
