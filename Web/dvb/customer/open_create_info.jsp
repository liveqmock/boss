...
function frm_submit(){
	...
	if(document.frmPost.OpenFlag.value!='0'&&document.frmPost.OpenFlag.value!='3'){
  ...
  if (checkCustomerInfo()&&checkAccountInfo()&&check_Bidimconfig()) { 
  	  ...
  	  if(document.frmPost.txtBirthday.value == "YYYY-MM-DD")
  	  	document.frmPost.txtBirthday.value = "";
  	  }
...
{
	if (check_Blank(document.frmPost.txtAgentName, false, "代理人姓名")){
		document.frmPost.txtAgentTelephone.value="";
		document.frmPost.txtAgentCardType.value="";
		document.frmPost.txtAgentCardId.value="";
		return true;
	}
	if (check_Blank(document.frmPost.txtAgentTelephone, true, "代理人联系电话"))
		return false;
	if (check_Blank(document.frmPost.txtAgentCardType, true, "代理人证件类型"))
		return false;
	if (check_Blank(document.frmPost.txtAgentCardId, true, "代理人证件号"))
		return false;
...
<form name="frmPost" method="post" action="check_address.do">
	...
	<table width="820" border="0" align="center" cellpadding="4" cellspacing="1" class="list_bg">
		<d:DynamicForm formName="openCreateCustomerInfo" functionName="checkCustomerInfo()" column="4">
			...
			<!--代理人信息-->
			<tr>
				<d:DynamicFormElement elementName="agentName" functionName="checkAgentName()">
					<td valign="middle" class="list_bg2" align="right">
						代理人姓名
					</td>
					<td class="list_bg1">
				...
				<d:DynamicFormElement elementName="agentTelephone">
					<td valign="middle" class="list_bg2" align="right">
						代理人电话
					</td>
					<td class="list_bg1">
			...
			<tr>
				<d:DynamicFormElement elementName="agentCardType">
					<td valign="middle" class="list_bg2" align="right">
						代理人证件类型
					</td>
					<td class="list_bg1">
				...
				<d:DynamicFormElement elementName="agentCardId">
					<td valign="middle" class="list_bg2" align="right">
						代理人证件号
					</td>
					<td class="list_bg1">
			...
			<tr id="prefered" <%if ((open_flag.equals(CommonKeys.ACTION_OF_SHOPACCOUNT)) && (preferTime.equals(""))){%>
				style="display:none" <%} %>>
					<td valign="middle" class="list_bg2" align="right" width="17%">
						预约上门日期*
					</td>
		 ...
		 %>
			...
			<tr>
				...
				<d:DynamicFormElement elementName="customerBirthday" functionName="checkBirthday()">
					...
					<td class="list_bg1">
						<input onfocus="viewModule(this)" onKeydown="inputDate(document.frmPost.txtBirthday)" onblur="lostFocus(this)" type="text" name="txtBirthday" size="25" maxlength="10" value="<tbl:writeparam name="txtBirthday" />"							class="text" style="ime-mode:disabled;" >						<IMG onclick="MyCalendar.SetDate(this,document.frmPost.txtBirthday,'N')" src="img/calendar.gif" style="cursor:hand" border="0">
					</td>
				</d:DynamicFormElement>
			</tr>
			...
			<tr>
				...
				<d:DynamicFormElement elementName="customerLoginPwd" functionName="checkLogInUser()">
					...
					<td class="list_bg1">
						<input type="password" name="txtLoginPwd" size="25"  maxlength="6" value="<tbl:writeparam name="txtLoginPwd" />">
					</td>
				</d:DynamicFormElement>
			</tr>
			<tr>
          ...
          <td class="list_bg1"><input type="password" name="txtLoginRePwd" size="25"  maxlength="6"  value="<tbl:writeparam name="txtLoginPwd" />" ></td>
	      </d:DynamicFormElement>
	    </tr>
			<tr>
		...
		<d:DynamicForm formName="openCreateAccountInfo" functionName="checkAccountInfo()" column="4">
			...
			<tr>
				...
				<d:DynamicFormElement elementName="BankAccount" >
					<td valign="middle" class="list_bg2" align="right">
						银行帐号
					</td>
					<td class="list_bg1">
