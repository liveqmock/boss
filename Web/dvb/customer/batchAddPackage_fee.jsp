...
function frm_submit() {
   document.frmPost.action ="batchAddPackage_confirm.screen";
   document.frmPost.submit();
}
</script>
...
<tbl:CommonFeeAndPaymentInfo includeParameter="Fee" payCsiType="<%=CommonKeys.CUSTSERVICEINTERACTIONTYPE_PN%>"  confirmFlag="false" />	
<br>
<table width="100%">
<tr>
<td>
