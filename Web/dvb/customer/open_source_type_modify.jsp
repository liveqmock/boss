...
function frm_submit(){
  ...
  if(document.frmPost.txtOpenSourceType.value==document.frmPost.txtOldOpenSourceType.value){
  	alert("修改前后的来源渠道一样,请重新选择");
  	return ;
  }
...
<form name="frmPost" method="post" action="open_source_type_modify.do" >
    <input type="hidden" name="Action" value="update">
    <input type="hidden" name="txtOldOpenSourceType" value="<tbl:writeparam name="txtOpenSourceType"/>" />
    ...
    <table width="100%"  border="0" align="center" cellpadding="4" cellspacing="1" class="list_bg">
       <tr>
	        <td valign="middle" class="list_bg2" align="right" width="34%">来源渠道*</td>
	        <td class="list_bg1" width="66%">
	          <d:selcmn name="txtOpenSourceType" mapName="SET_C_CUSTOPENSOURCETYPE" match="txtOpenSourceType"  width="23"  /> 
	        </td>
       </tr>
