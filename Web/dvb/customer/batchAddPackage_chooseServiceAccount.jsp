...
function next_submit(){
	 ...
	 document.frmPost.action="batchAddPackage_chooseSoftPackage.do";
	 document.frmPost.submit();
}
...
<table  border="0" align="center" cellpadding="0" cellspacing="10" >
  <tr>
    ...
    <td class="title">批量增加产品包--->选择业务账户</td>
  </tr>
</table>
...
<form name="frmPost" action="batchAddPackage_chooseServiceAccount.do" method="post" > 
	 <input type="hidden" name="txtCsiType" value="<%=CommonKeys.CUSTSERVICEINTERACTIONTYPE_PN%>" >
