...
<div id="updselwaitlayer" style="position:absolute; left:650px; top:170px; width:250px; height:24px; display:none">
  ...
  <form name="frmPost" method="post" action="book_product_confirm.do" >
<table  border="0" align="center" cellpadding="0" cellspacing="10" >
  <tr>
    <td><img src="img/list_tit.gif" width="19" height="19"></td>
    <td class="title">预约新增产品信息确认</td>
  </tr>
</table>
  <br>
  ...
  <tr>
    ...
    <td class="list_bg1"  align="left"><tbl:writeparam name="txtUsedMonth" /></td>    
  </tr>
  <tr>
...
<input type="hidden" name="func_flag" value="119">
<input type="hidden" name="txtType" value="<%=CommonKeys.CUSTSERVICEINTERACTIONTYPE_BP%>">
<input type="hidden" name="confirm_post" value="">

<tbl:hiddenparameters pass="OpenCampaignList/MutiProductList/SingleProductList/GeneralCampaignList/txtCsiCreateReason/txtUsedMonth" /> 
