...
function frm_submit()
{
    if(check_form())
    {
    	...
    	document.frmPost.action = "customer_deposit_confiscate_confirm.do";
...
<%
pageContext.setAttribute("AllMOPList" ,Postern.getOpeningPaymentMop(CommonKeys.CUSTSERVICEINTERACTIONTYPE_FS));
%>
<table align="center" width="100%" border="0" cellpadding="4" cellspacing="1" class="list_bg">
	<tr> 
		<td class="import_tit" align="center" colspan="3"><font size="3">没收押金</font></td>
	</tr>
	<tr>
		<td class="list_bg2" align="center" width="35%">*没收方式：<tbl:select name="MOP" set="AllMOPList" match="MOP" width="18" /></td>
		<td class="list_bg2" align="center" width="30%">*没收金额：<input name="txtPay" type="text" size="12" class="text"></td>
		<td class="list_bg2" align="center" width="35%">票据编号：<input name="billNo" type="text" size="18" class="text"></td>
	</tr>
</table>
...
<table align="center" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td><input name="next" type="button" class="button" onClick="javascript:frm_submit()" value="没收押金"></td>
