...
<%@ taglib uri="osstags" prefix="d" %>
 ...
 <table width="810"  border="0" align="center" cellpadding="4" cellspacing="1" class="list_bg">
         ...
         <tr>
           ...
           <td class="list_bg1" align="left"><font size="2">
               <input type="text" name="txtAdjustReasonName" value="<d:getcmnname typeName="SET_F_ACCOUNTADJUSTMENTREASON" match="txtAdjustReason" />" readonly="true" class="textgray">
               <input type="hidden" name="txtAdjustReason" value="<tbl:writeparam name="txtAdjustReason"  />" >
           </font> </td>
         </tr> 
         <tr>
           <td class="list_bg2" align="right">调账备注</td>
           <td class="list_bg1" colspan="3" align="left"><font size="2">
               <input type="text" name="txtadjustReMark" maxlength="100" size="50" value="<tbl:writeparam name="txtadjustReMark" />" class="textgray" readonly="true" >
           </font> </td>                      
         </tr> 
     </table>